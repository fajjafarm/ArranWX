<x-app-layout :assets="$assets ?? []" title='Border Table' :isBanner="true">
<div class="row">
   <div class="col-lg-12">
       <div class="card">
                    ...
                    <table class="table mb-0" id="datatable" data-toggle="data-table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/1.png')}}" alt="" loading="lazy" />
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/2.png')}}" alt="" loading="lazy" />
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/3.png')}}" alt="" loading="lazy" />
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/4.png')}}" alt="" loading="lazy" />
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/5.png')}}" alt="" loading="lazy" />
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/6.png')}}" alt="" loading="lazy" />
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/7.png')}}" alt="" loading="lazy" />
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/8.png')}}" alt="" loading="lazy" />
                                        <div class="media-support-info">
                                        <h5 class="iq-sub-label">Elon Musk</h5>
                                        <p class="mb-0">@musk</p>
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/9.png')}}" alt="" loading="lazy" />
                                        <div class="media-support-info">
                                        <h5 class="iq-sub-label">Elon Musk</h5>
                                        <p class="mb-0">@musk</p>
                                        </div>
