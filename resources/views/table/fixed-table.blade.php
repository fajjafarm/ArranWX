<x-app-layout :assets="$assets ?? []" title='Fixed Table' :isBanner="true">
<div class="row">
      <div class="col-sm-12">
         <div class="card">
                    ...
                    <tbody>
                          ...
                          <td>
                              <div class="d-flex align-items-center">
                                <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="{{asset('images/shapes/01.png')}}" alt="profile" loading="lazy" />
                        ...
                        <tr>
                          <td>
                              <div class="d-flex align-items-center">
                                <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="{{asset('images/shapes/02.png')}}" alt="profile" loading="lazy" />
                        ...
                        <tr>
                          <td>
                              <div class="d-flex align-items-center">
                                <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="{{asset('images/shapes/03.png')}}" alt="profile" loading="lazy" />
                        ...
                        <tr>
                          <td>
                              <div class="d-flex align-items-center">
                                <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="{{asset('images/shapes/04.png')}}" alt="profile" loading="lazy" />
                        ...
                        <tr>
                          <td>
                              <div class="d-flex align-items-center">
                                <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="{{asset('images/shapes/06.png')}}" alt="profile" loading="lazy" />
