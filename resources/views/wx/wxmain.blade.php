<x-app-layout :assets="$assets ?? []" title="Home" isSelect2="true" isTour="true" isFlatpickr="true"  :isSidebar="true" :isBanner="false" :isPageContainer="true">
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 gap-3">
        <div class="d-flex flex-column">
            <h3>Arran Weather Data</h3>
            <p class="text-primary mb-0">current conditions</p>
        </div>
        <div class="d-flex justify-content-between align-items-center rounded flex-wrap gap-3">
            ...
            <div class="card card-block card-stretch card-height">
                <div class="card-header">
                        ...
                        <h4 class="card-title">Wind Speed (mph)</h4>
                        <div class="dropdown">
            ...
            <div class="card card-block card-stretch card-height">
                <div class="card-header">
                        <div class=" d-flex justify-content-between  flex-wrap">
                        <h4 class="card-title">Temperature (&deg;C)</h4>
                        <div class="dropdown">
                         <a href="#" class="text-secondary dropdown-toggle" id="dropdownMenuButton22" data-bs-toggle="dropdown" aria-expanded="false">
                         This year
                         </a>
            ...
            <div class="card card-block card-stretch card-height">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between mb-2">
                        <p class="mb-0 text-dark">Rainfall (mm)</p>
