...
$json = \File::get('ferryforecast.json');
...
echo ' <td class="text-dark"> '.($data['properties']['timeseries'][$i]['data']['next_1_hours']['details']['precipitation_amount']).'mm</td>';
echo ' <td class="text-dark"> '.($data['properties']['timeseries'][$i]['data']['instant']['details']['ultraviolet_index_clear_sky']). '</td>';
