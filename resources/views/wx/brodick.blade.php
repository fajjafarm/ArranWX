...
echo ' <td class="text-dark" style="height: 100%"><div style="display: flex; align-items: center; justify-content: center;background-color:rgba(0, 0,255, '.$precipb.');'.$rpcolor.'""> '.$rain.' mm </div></td>';
