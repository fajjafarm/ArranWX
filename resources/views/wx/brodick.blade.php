...
echo ' <td class="text-dark" style="height: 100%"><div style="height: 100%; width: 100%; '.$bggrad.'; ">'.$wind. ' mph</div></td>';
echo ' <td class="text-dark" style="height: 100%"><div style="height: 100%; width: 100%; '.$bggradgust.'; ">'.$gust. ' mph*</div></td>';
