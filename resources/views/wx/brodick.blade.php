...
echo ' <td class="text-dark" style="height: 100%"><div style="height: 100%; width: 100%; text-align: center;background-color:rgba(0, 0,255, '.$precipb.');'.$rpcolor.'""> '.$rain.' mm </div></td>';
