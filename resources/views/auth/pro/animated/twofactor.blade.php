            ...
            <div class="col-10 col-lg-4 offset-lg-7 offset-1">
                <div class="card">
                    ...
                    <div class="form-group me-3">
                            <label class="form-label" for="phone01">Phone Number</label>
                            <input type="email" class="form-control mb-0" id="phone01" placeholder="Enter Phone Number">
                        </div>
                    <button type="button" class="btn btn-primary mb-4">Send OTP</button>
                    <div class="form-group me-3">
