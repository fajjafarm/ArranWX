...
<head>
    ...
    <title data-setting="app_name" data-rightJoin=" Boxed Fancy | Responsive Bootstrap 5 Admin Dashboard Template">
        {{ env('APP_NAME') }} Boxed Fancy | Responsive Bootstrap 5 Admin Dashboard Template</title>
    <!-- Style Link start -->
