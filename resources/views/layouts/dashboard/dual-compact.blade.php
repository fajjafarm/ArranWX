...
<head>
    ...
    <title data-setting="app_name" data-rightJoin=" Dual Compact | Responsive Bootstrap 5 Admin Dashboard Template">
        {{ env('APP_NAME') }} Dual Compact | Responsive Bootstrap 5 Admin Dashboard Template</title>
    <!-- Style Link start -->
...
<body class="dual-compact">
    ...
    <main class="main-content">
        ...
        <!-- Header Start-->
        @include('components.partials._body_header4')
        <!-- Header End-->
