...
<x-app-layout :assets="$assets ?? []" title='UI Color' :isBanner="true">
      ...
      <div class="row">
            ...
            <div class="card">
               <div class="card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title">Hope UI Color</h4>
                  </div>
               </div>
               <div class="card-body">
         ...
         <div class="col-lg-6">
            <div class="card">
               <div class="card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title">Hope UI Text Color</h4>
                  </div>
               </div>
               <div class="card-body">
         ...
         <div class="col-lg-6">
            <div class="card">
               ...
               <div class="card-body">
                  ...
                  <p class="bg-soft-info ps-3 pe-3 pt-2 pb-2 rounded">bg-Info link</p>
         ...
         <div class="col-lg-6">
            <div class="card">
               ...
               <div class="card-body">
                  ...
                  <p><a href="#" class="bg-soft-info ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">bg-Info link</a></p>
                  <p class="mb-0"><a href="#" class="dark ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Dark link</a></p>
               </div>
            </div>
         </div>
      </div>
