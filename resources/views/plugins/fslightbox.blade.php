<x-app-layout :assets="$assets ?? []" title='Fslightbox' :isBanner="true" isFslightbox="true">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                ...
                <div class="card-body text-center">
                    <div class="d-grid gap-card grid-cols-3 iq-fslightbox-img">
                        <a data-fslightbox="gallery" href="{{asset('images/pro/plugins/img6.jpeg')}}">
                            <img src="{{asset('images/pro/plugins/img6.jpeg')}}" class="img-fluid bg-soft-primary rounded"
                                alt="profile-image">
                        </a>
                        <a data-fslightbox="gallery" href="{{asset('images/pro/plugins/img1.jpeg')}}">
                            <img src="{{asset('images/pro/plugins/img1.jpeg')}}" class="img-fluid bg-soft-primary rounded"
                                alt="profile-image">
                        </a>
                        <a data-fslightbox="gallery" href="{{asset('/images/pro/plugins/img2.jpg')}}">
                            <img src="{{asset('/images/pro/plugins/img2.jpg')}}" class="img-fluid bg-soft-primary rounded"
                                alt="profile-image">
                        </a>
                        <a data-fslightbox="gallery" href="{{asset('images/pro/plugins/img3.jpeg')}}">
                            <img src="{{asset('images/pro/plugins/img3.jpeg')}}" class="img-fluid bg-soft-primary rounded"
                                alt="profile-image">
                        </a>
                        <a data-fslightbox="gallery" href="{{asset('images/pro/plugins/img4.jpeg')}}">
                            <img src="{{asset('images/pro/plugins/img4.jpeg')}}" class="img-fluid bg-soft-primary rounded"
                                alt="profile-image">
                        </a>
                        <a data-fslightbox="gallery" href="{{asset('images/pro/plugins/img5.jpeg')}}">
                            <img src="{{asset('images/pro/plugins/img5.jpeg')}}" class="img-fluid bg-soft-primary rounded"
                                alt="profile-image">
                        </a>
                    </div>
                </div>
                ...
                <div class="card-body text-center">
                    <div class="d-grid gap-card grid-cols-3 iq-fslightbox-img">
                        <a data-fslightbox="html5-video" data-video-poster="{{asset('/images/pro/plugins/img7.jpg')}}"
                            ...
                            <img src="{{asset('images/pro/plugins/img7.jpg')}}" class="img-fluid bg-soft-primary rounded"
                        ...
                        <a data-fslightbox="html5-video" data-video-poster="{{asset('/images/pro/plugins/img8.jpg')}}"
                            ...
                            <img src="{{asset('/images/pro/plugins/img8.jpg')}}" class="img-fluid bg-soft-primary rounded"
                        ...
                        <a data-fslightbox="html5-video" data-video-poster="{{asset('/images/pro/plugins/img9.jpg')}}"
                            ...
                            <img src="{{asset('images/pro/plugins/img9.jpg')}}" class="img-fluid bg-soft-primary rounded"
                ...
                <div class="card-body text-center">
                    <div class="d-grid gap-card grid-cols-3 iq-fslightbox-img">
                        <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=3nQNiWdeH2Q">
                            <img class="img-fluid bg-soft-primary rounded" src="{{asset('images/pro/plugins/img10.jpg')}}"
                                alt="Heroes Tonight - Fullscreen Lightbox">
                        </a>
                        <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=TW9d8vYrVFQ">
                            <img class="img-fluid bg-soft-primary rounded" src="{{asset('images/pro/plugins/img11.jpg')}}"
                                alt="Sky High - Fullscreen Lightbox">
                        </a>
                        <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=zyXmsVwZqX4">
                            <img class="img-fluid bg-soft-primary rounded" src="{{asset('images/pro/plugins/img12.jpg')}}"
