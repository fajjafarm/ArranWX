      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="d-flex justify-content-between align-items-center mb-2">
            <div class="label">
              <h5 class="mb-3 d-inline-block">Logo </h5><small class="ms-2">Preview Only</small><span class="badge bg-danger ms-2">Soon</span>
            </div>
            <div class="action btn py-0">
          ...
          <div class="d-grid gap-3 grid-cols-1 mb-4">
            <div class="form-group mb-0">
              <input class="form-control" type="file" id="setting-logo" name="setting_logo">
            </div>
          </div>

          <hr class="hr-horizontal">

          <h5 class="mb-3 mt-4 d-inline-block">Body Font</h5><small class="ms-2">Preview Only</small>
          <div class="d-grid gap-3 grid-cols-1 mb-4">
            <div class="form-group mb-0">
              <select name="body_font" class="form-control" data-select="font" data-change="body-font">
          ...
          <h5 class="mb-3 mt-4 d-inline-block">Heading Font</h5><small class="ms-2">Preview Only</small>
          <div class="d-grid gap-3 grid-cols-1 mb-4">
            <div class="form-group mb-0">
              <select name="heading_font" class="form-control" data-select="font" data-change="heading-font">
          ...
          <h5 class="mb-3 mt-4">Storage</h5>
          <div class="d-grid gap-3 grid-cols-3 mb-4">
            <div data-setting="radio">
              <input type="radio" value="localStorage" class="btn-check" name="saveLocal" id="save-localstorage" autocomplete="off">
              <label class="btn btn-border d-block" for="save-localstorage">Local</label>
            </div>
            <div data-setting="radio">
              <input type="radio" value="sessionStorage" class="btn-check" name="saveLocal" id="save-sessionstorage" autocomplete="off">
              <label class="btn btn-border d-block" for="save-sessionstorage">Session</label>
            </div>
            <div data-setting="radio">
              <input type="radio" value="null" class="btn-check" name="saveLocal" id="save-none" autocomplete="off" checked>
          ...
          <!-- Scheme start here -->
           ...
           <h5 class="mb-3 mt-4">Scheme</h5>
          <div class="d-grid gap-3 grid-cols-3 mb-4">
            <div data-setting="radio" >
              <input type="radio" value="auto" class="btn-check" name="theme_scheme" id="color-mode-auto" autocomplete="off" checked>
            ...
            <div data-setting="radio">
              <input type="radio" value="dark" class="btn-check" name="theme_scheme" id="color-mode-dark" autocomplete="off">
            ...
            <div data-setting="radio">
              <input type="radio" value="light" class="btn-check" name="theme_scheme" id="color-mode-light" autocomplete="off">
          ...
          <div class="d-flex align-items-center justify-content-between">
            ...
            <div data-setting="radio">
              <input type="radio" value="theme-color-default" class="btn-check" name="theme_color" id="theme-color-default">
          ...
          <div class="grid-cols-5 mb-4 d-grid gap-3">
            <div data-setting="radio">
              ...
              <label class="btn btn-border d-block bg-transparent" for="theme-color-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Theme-1" data-bs-original-title="Theme-1">
                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26"> <circle cx="12" cy="12" r="10" fill="#00C3F9" /> <path d="M2,12 a1,1 1 1,0 20,0" fill="#573BFF" /></svg>
              </label>
            </div>
            <div data-setting="radio">
              <input type="radio" value="theme-color-gray" class="btn-check" name="theme_color" id="theme-color-2">
              <label class="btn btn-border d-block bg-transparent" for="theme-color-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Theme-2" data-bs-original-title="Theme-2">
                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26"> <circle cx="12" cy="12" r="10" fill="#91969E" /> <path d="M2,12 a1,1 1 1,0 20,0" fill="#FD8D00" /></svg>
              </label>
            </div>
            <div data-setting="radio">
              <input type="radio" value="theme-color-red" class="btn-check" name="theme_color" id="theme-color-3">
              <label class="btn btn-border d-block bg-transparent" for="theme-color-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Theme-3" data-bs-original-title="Theme-3">
                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26"> <circle cx="12" cy="12" r="10" fill="#DB5363" /> <path d="M2,12 a1,1 1 1,0 20,0" fill="#366AF0" /></svg>
              </label>
            </div>
            <div data-setting="radio">
              <input type="radio" value="theme-color-yellow" class="btn-check" name="theme_color" id="theme-color-4">
              <label class="btn btn-border d-block bg-transparent" for="theme-color-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Theme-4" data-bs-original-title="Theme-4">
                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26"> <circle cx="12" cy="12" r="10" fill="#EA6A12" /> <path d="M2,12 a1,1 1 1,0 20,0" fill="#6410F1" /></svg>
              </label>
            </div>
            <div data-setting="radio">
              <input type="radio" value="theme-color-pink" class="btn-check" name="theme_color" id="theme-color-5">
              <label class="btn btn-border d-block bg-transparent" for="theme-color-5" data-bs-toggle="tooltip" data-bs-placement="top" title="Theme-5" data-bs-original-title="Theme-5">
                <svg class="customizer-btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26"> <circle cx="12" cy="12" r="10" fill="#E586B3" /> <path d="M2,12 a1,1 1 1,0 20,0" fill="#25C799" /></svg>
              </label>
            </div>
          </div>
          ...
          <h5 class="mt-4 d-inline-block mb-3 me-2">Page Container </h5><small class="badge bg-danger">Pro</small>
          <div class="d-grid gap-3 grid-cols-2 mb-4">
            ...
            <div data-setting="radio">
              <input type="radio" value="container-fluid" class="btn-check" name="page_layout" id="page-layout-full-width" autocomplete="off" checked>
          ...
          <h5 class="mt-4 d-inline-block mb-3 me-2">Style Appearance </h5><small class="badge bg-danger">Pro</small>
          <div class="d-grid gap-3 grid-cols-2 mb-4">
            <div data-setting="checkbox">
              <input type="checkbox" value="theme-flat" class="btn-check" name="theme_style_appearance" id="theme-style-appearance-flat" autocomplete="off">
              <label class="btn btn-border d-block" for="theme-style-appearance-flat">Flat</label>
            </div>
            <div data-setting="checkbox">
              <input type="checkbox" value="theme-bordered" class="btn-check" name="theme_style_appearance" id="theme-style-appearance-bordered" autocomplete="off">
              <label class="btn btn-border d-block" for="theme-style-appearance-bordered">Bordered</label>
            </div>
            <div data-setting="checkbox">
              <input type="checkbox" value="theme-sharp" class="btn-check" name="theme_style_appearance" id="theme-style-appearance-sharp" autocomplete="off">
              <label class="btn btn-border d-block" for="theme-style-appearance-sharp">Sharp</label>
            </div>
            <div data-setting="checkbox">
              <input type="checkbox" value="theme-default" class="btn-check" name="theme_style_appearance" id="theme-style-appearance-default" autocomplete="off" checked>
              <label class="btn btn-border d-block" for="theme-style-appearance-default">Default</label>
            </div>
          </div>
          ...
          <!-- Scheme direction start here -->

          <h5 class="mb-3 mt-4">Scheme Direction</h5>
          <div class="d-grid gap-3 grid-cols-2 mb-4">
            <div data-setting="attribute" class="text-center">
              <input type="radio" value="ltr" class="btn-check" name="theme_scheme_direction" data-prop="dir" id="theme-scheme-direction-ltr" autocomplete="off" checked>
              <label class="btn btn-border d-block p-0" for="theme-scheme-direction-ltr">
                <img src="{{ asset('images/settings/dark/01.png') }}" alt="ltr" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/01.png') }}" alt="ltr" class="mode light-img img-fluid">
              </label>
              <span class=" mt-2"> LTR </span>
            </div>
            <div data-setting="attribute" class="text-center">
              <input type="radio" value="rtl" class="btn-check" name="theme_scheme_direction" data-prop="dir" id="theme-scheme-direction-rtl" autocomplete="off">
              <label class="btn btn-border d-block p-0" for="theme-scheme-direction-rtl">
                <img src="{{ asset('images/settings/dark/02.png') }}" alt="ltr" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/12.png') }}" alt="ltr" class="mode light-img img-fluid">
              </label>
              <span class=" mt-2"> RTL </span>
            </div>
          </div>

          <!-- Scheme direction end here -->

          <hr class="hr-horizontal">

          <!-- Sidebar color start here -->
          ...
          <!-- Sidebar active style start here -->

          <h5 class="mt-4 mb-3">Sidebar Active Style</h5>

          <div class="d-grid gap-3 grid-cols-2 mb-4">
            <div data-setting="radio" class="text-center">
              <input type="radio" value="navs-rounded" class="btn-check" name="sidebar_menu_style" id="navs-rounded" autocomplete="off">
              <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-rounded">
                <img src="{{ asset('images/settings/dark/06.png') }}" alt="mini" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/06.png') }}" alt="mini" class="mode light-img img-fluid">
              </label>
              <span class="mt-2">Rounded One Side</span>
            </div>
            <div data-setting="radio" class="text-center">
              <input type="radio" value="navs-rounded-all" class="btn-check" name="sidebar_menu_style" id="navs-rounded-all" autocomplete="off">
              <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-rounded-all">
                <img src="{{ asset('images/settings/dark/07.png') }}" alt="hover" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/07.png') }}" alt="hover" class="mode light-img img-fluid">
              </label>
              <span class="mt-2">Rounded All</span>
            </div>
            <div data-setting="radio" class="text-center">
              <input type="radio" value="navs-pill" class="btn-check" name="sidebar_menu_style" id="navs-pill" autocomplete="off">
              <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill">
                <img src="{{ asset('images/settings/dark/09.png') }}" alt="boxed" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/09.png') }}" alt="boxed" class="mode light-img img-fluid">
              </label>
              <span class="mt-2">Pill One Side</span>
            </div>
            <div data-setting="radio" class="text-center">
              <input type="radio" value="navs-pill-all" class="btn-check" name="sidebar_menu_style" id="navs-pill-all" autocomplete="off">
              <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill-all">
                <img src="{{ asset('images/settings/dark/08.png') }}" alt="boxed" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/08.png') }}" alt="boxed" class="mode light-img img-fluid">
              </label>
              <span class="mt-2">Pill All</span>
            </div>
            <div data-setting="radio" class="text-center">
              <input type="radio" value="left-bordered" class="btn-check" name="sidebar_menu_style" id="left-bordered" autocomplete="off" checked>
              <label class="btn btn-border p-0 d-block overflow-hidden" for="left-bordered">
                <img src="{{ asset('images/settings/dark/05.png') }}" alt="boxed" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/05.png') }}" alt="boxed" class="mode light-img img-fluid">
          ...
          <div class="d-grid gap-3 grid-cols-3 mb-4">
            <div data-setting="radio" class="text-center">
              ...
              <label class="btn btn-border p-0 d-block overflow-hidden" for="nav-glass">
                <img src="{{ asset('images/settings/dark/10.png') }}" alt="hover" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/10.png') }}" alt="hover" class="mode light-img img-fluid">
              </label>
            ...
            <div data-setting="radio" class="text-center">
              ...
              <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-transparent">
                <img src="{{ asset('images/settings/dark/12.png') }}" alt="boxed" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/12.png') }}" alt="boxed" class="mode light-img img-fluid">
              </label>
          ...
          <h5 class="mt-4 mb-3">Banner Style</h5>

          <div class="d-grid gap-3 grid-cols-3 mb-4">
            <div data-setting="radio" class="text-center">
              <input type="radio" value="navs-bg-color" class="btn-check" name="header_banner" id="header-banner-color" autocomplete="off">
              <label class="btn btn-border p-0 d-block overflow-hidden" for="header-banner-color">
                <img src="{{ asset('images/settings/dark/11.png') }}" alt="hover" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/11.png') }}" alt="hover" class="mode light-img img-fluid">
              </label>
              <span class="mt-2">Color</span>
            </div>
            <div data-setting="radio" class="text-center">
              <input type="radio" value="default" class="btn-check" name="header_banner" id="header-banner-default" autocomplete="off">
              <label class="btn btn-border p-0 d-block overflow-hidden" for="header-banner-default">
                <img src="{{ asset('images/settings/dark/04.png') }}" alt="hover" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/light/04.png') }}" alt="hover" class="mode light-img img-fluid">
              </label>
            ...
            <div data-setting="radio" class="text-center">
              <input type="radio" value="hide" class="btn-check" name="header_banner" id="hide-banner" autocomplete="off" checked>
              <label class="btn btn-border p-0 d-block overflow-hidden" for="hide-banner">
                <img src="{{ asset('images/settings/dark/05.png') }}" alt="boxed" class="mode dark-img img-fluid">
                <img src="{{ asset('images/settings/dark/05.png') }}" alt="boxed" class="mode light-img img-fluid">
                <small class="badge bg-danger position-absolute top-1 end-0 m-2">Pro</small>
              </label>
          ...
          <div class="d-grid gap-3 grid-cols-2 mt-4">
            <button class="btn btn-outline-primary" data-reset="settings" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset All Retting">
            ...
            <button class="btn btn-outline-primary" data-copy="settings" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
