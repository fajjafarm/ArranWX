<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
  <div class="container-fluid navbar-inner">
    <a href="{{route('dashboards')}}" class="navbar-brand">
      ...
      <h4 class="logo-title d-none d-sm-block" data-setting="app_name"><img src="{{asset('images/awlogo.svg')}}" width="30" height="30" /> Arran Weather</h4>
    </a>
        ...
        <li class="nav-item dropdown">
          ...
          <img src="{{asset('images/avatars/avtar_3.png')}}" alt="User-Profile" class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded">
            <div class="caption ms-3 d-none d-md-block ">
              ...
              <p class="mb-0 caption-sub-title text-capitalize">{{ str_replace('_',' ',optional(auth()->user())->user_type) ?? 'Marketing Administrator' }}</p>
            </div>
          </a>
