    ...
    <div class="offcanvas-header">
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <button class="btn btn-primary btn-icon" data-reset="settings" data-bs-toggle="tooltip"
                data-bs-placement="left" title="Reset All Retting">
                            ...
                            <div class="d-grid gap-3 grid-cols-2 mb-4">
                                ...
                                <div data-setting="attribute" class="text-center">
                                    ...
                                    <label class="btn btn-border d-block p-0" for="theme-scheme-direction-rtl">
                                        <img src="{{ asset('images/settings/dark/02.png') }}" alt="ltr"
                                            class="mode dark-img img-fluid" width="200" height="200"
                                            loading="lazy">
                                        <img src="{{ asset('images/settings/light/02.png') }}" alt="ltr"
                                            class="mode light-img img-fluid" width="200" height="200"
                                            loading="lazy">
                                    </label>
                                ...
                                <div class="d-grid gap-3 grid-cols-3 mb-4">
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-rounded">
                                            <img src="{{ asset('images/settings/dark/06.png') }}" alt="mini"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/06.png') }}" alt="mini"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            ...
                                            <img src="{{ asset('images/settings/dark/07.png') }}" alt="hover"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/07.png') }}" alt="hover"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill">
                                            <img src="{{ asset('images/settings/dark/09.png') }}" alt="boxed"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/09.png') }}" alt="boxed"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill-all">
                                            <img src="{{ asset('images/settings/dark/08.png') }}" alt="boxed"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/08.png') }}" alt="boxed"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            for="navs-full-width">
                                            <img src="{{ asset('images/settings/dark/15.png') }}" alt="boxed"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/15.png') }}" alt="boxed"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <small
                                                class="badge bg-danger position-absolute top-1 end-0 m-2">Pro</small>
                                ...
                                <div class="d-grid gap-3 grid-cols-4 mb-4">
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="nav-glass">
                                            <img src="{{ asset('images/settings/dark/10.png') }}" alt="hover"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/10.png') }}" alt="hover"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            ...
                                            <img src="{{ asset('images/settings/dark/12.png') }}" alt="boxed"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/12.png') }}" alt="boxed"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-default">
                                            <img src="{{ asset('images/settings/dark/01.png') }}" alt="default"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/01.png') }}" alt="default"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
                                ...
                                <div class="d-grid gap-3 grid-cols-3 mb-4">
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            ...
                                            <img src="{{ asset('images/settings/dark/11.png') }}" alt="hover"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ asset('images/settings/light/11.png') }}" alt="hover"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
                    ...
                    <div class="p-3">
                        ...
                        <div class="d-grid gap-3 grid-cols-1 mb-4">
                            <div class="form-group mb-0">
                                <input type="text" data-setting="input" maxlength="20" name="app_name"
                        ...
                        <div class="d-grid gap-3 grid-cols-3 mb-4">
                            ...
                            <div data-setting="radio">
                                <input type="radio" value="null" class="btn-check" name="saveLocal"
