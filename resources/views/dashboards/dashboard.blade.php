<x-app-layout :assets="$assets ?? []" title="Home" isSelect2="true" isTour="true" isFlatpickr="true"  :isSidebar="true" :isBanner="false" :isPageContainer="true">
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 gap-3">
        <div class="d-flex flex-column">
            ...
            <p class="text-primary mb-0">Arran Weather Data</p>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body">
                            <div class="mb-2 d-flex justify-content-between align-items-center">
                                <span class="text-dark">Rain Days</span>
                                <a class="badge rounded-pill bg-soft-primary" href="javascript:void(0);">
                                    View
                                </a>
                            </div>
                            <h2 class="counter">367</h2>
                            <small>Rain with rainfall month</small>
                        </div>
                    </div>
                </div>
            </div>
