 ...
 * ***/
 (function (window) {
  ...
  IQSetting.prototype.setSettingColorChoice = function (key, pair) {
  ...
  IQSetting.prototype.resetColor = function (key) {
  ...
  IQSetting.prototype.card_color = function (value) {
    if (typeof value !== typeof null) {
     ...
     // 18. sidebar_show function to the IQSetting prototype @params: value (string)
  ...
  // 19. header_navbar_show function to the IQSetting prototype @params: value (string)
  ...
  if (resetFont !== null) {
    resetFont.addEventListener("click", (e) => {
      e.preventDefault();
      IQSetting.setSettingOption("body_font_family", "Inter", true);
      IQSetting.setSettingOption("heading_font_family", "Inter", true);
      IQSetting.resetFontFamily();
    });
  }
