<x-app-layout layout="blog" :assets="$assets ?? []" :isBanner="false" :isSwiperSlider="true" title='Dashboard'>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div>
                ...
                <div class="overflow-hidden blog-analysis-slider position-relative custom-silder-01 trending-blogs">
                    <ul class="p-0 m-0 swiper-wrapper list-inline">
                        <li class="swiper-slide card-slide">
                            <div>
                                <x-modules.blog.widgets.blog-card masonrycard="false" classname="" blogimage="app/01.png" blogdate="02 Dec 2021." blogcontent="The Expierience: The Travel Tales From India and Abroad."  blogcontent1="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Egestas dolor at feugiat in tempor maecenas placerat..."/>
                            </div>
                        </li>
                        <li class="swiper-slide card-slide">
                            <div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-xl-6 col-md-6 p-0 d-flex align-items-center justify-content-center flex-column">
                            <div class="d-flex align-items-center">
                                <h4 class="text-primary">1,293</h4>
                                <p class="mb-0 ms-3">Daily</p>
                            </div>
                            <div class="d-flex align-items-center my-4">
                                <h4 class="text-primary">10,237</h4>
                                <p class="mb-0 ms-3">Monthly</p>
                            </div>
                            <div class="d-flex align-items-center">
                                <h4 class="text-primary">11,293</h4>
                                <p class="mb-0 ms-3">Yearly</p>
                            </div>
                        </div>
                    </div>
                </div>
