    ...
    <div class="mb-5">
        <div class="d-flex justify-content-between mb-4">
            ...
            <div class="dropdown d-flex align-items-center">
                Sort by : Date
                <svg width="14" class="ms-1"  id="dropdownMenuLink1" role="button" data-bs-toggle="dropdown" aria-expanded="false" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="mb-4">
                    <p class="blog-line-around text-secondary mb-0">
                        <span class="blog-line-day px-4">Today</span>
                    </p>
                </div>
                <div class="col">
                    <x-modules.blog.widgets.top-blog-list blogimage="blog-list/01.png" blogdate="14 Dec 2021" blogheader="How To Make Green Bean." blogsmall1="Food" blogsmall2="Brooklyn Simmons" blogcontent="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla turpis purus vitae tortor, nisl, aliquam. Sodaleset..."/>
                </div>
                <div class="col">
                    <x-modules.blog.widgets.top-blog-list blogimage="blog-list/02.png" blogdate="02 Dec 2021" blogheader="The Ultimate Travel Guide: What To Do, See & Eat." blogsmall1="Food" blogsmall2="Brooklyn Simmons" blogcontent="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla turpis purus vitae tortor, nisl, aliquam. Sodaleset..."/>
                </div>
                <div class="my-5">
                    <p class="blog-line-around text-secondary mb-0">
                ...
                <div class="col">
                    <x-modules.blog.widgets.top-blog-list blogimage="blog-list/03.png" blogdate="03 Aug 2021" blogheader="WIT AND DELIGHT: The Advice From A Twenty Something" blogsmall1="Food" blogsmall2="Brooklyn Simmons" blogcontent="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla turpis purus vitae tortor, nisl, aliquam. Sodaleset..."/>
                </div>
                <div class="col">
                    <x-modules.blog.widgets.top-blog-list blogimage="blog-list/04.png" blogdate="02 Dec 2021" blogheader="The Cheapest Destinations of All Time, A list of Beauty and Budget." blogsmall1="Food" blogsmall2="Brooklyn Simmons" blogcontent="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla turpis purus vitae tortor, nisl, aliquam. Sodaleset..."/>
                </div>
                <div class="col">
                    <x-modules.blog.widgets.top-blog-list blogimage="blog-list/05.png" blogdate="02 Dec 2021" blogheader="The Foreign and Domestic Culinary Adventures: An Art." blogsmall1="Food" blogsmall2="Brooklyn Simmons" blogcontent="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla turpis purus vitae tortor, nisl, aliquam. Sodaleset..."/>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-3">Author of the Week</h4>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle avatar-130" src="{{asset('modules/blog/images/blog-avatar/01.png')}}" alt="user-img">
                            <div class="ms-3">
                                <h6 class="mb-2 text-primary">Loren Banks</h6>
                                <div class="d-flex justify-content-start align-items-center">
                                    Travel<span class="mx-2"> | </span>
                                    <span class="d-flex  align-items-center">
                                        ...
                                        </svg> <span class="ms-2">4.2</span>
                                    </span>
                                </div>
                                <p class="mt-2">Elit vitae neque velit mattis elementum egestas non, Sem eget.</p>
                    ...
                    <div class="card-body p-0">
                        <div class="row row-cols-1 row-cols-md-2">
                            <div class="col">
                                <div class="card">
                                    <div class="card-body ">
                                        <img src="{{asset('modules/blog/images/blog-dashboard/09.png')}}" class="img-fluid rounded-top object-cover iq-top-categories" alt="Top-Categories">
                                        <div class="text-center">
                                            <h5 class="mb-0 para-ellipsis-1">Food</h5>
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        <img class="img-fluid rounded-top object-cover iq-top-categories" src="{{asset('modules/blog/images/blog-dashboard/10.png')}}" alt="01">
                                        <div class="text-center">
                                            <h5 class="mb-0 para-ellipsis-1">Travel</h5>
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        <img class="img-fluid rounded-top object-cover iq-top-categories" src="{{asset('modules/blog/images/blog-dashboard/11.png')}}" alt="01">
                                        <div class="text-center">
                                            <h5 class="mb-0 para-ellipsis-1">Workspace</h5>
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        <img class="img-fluid rounded-top object-cover iq-top-categories" src="{{asset('modules/blog/images/blog-dashboard/12.png')}}" alt="01">
                                        <div class="text-center">
                                            <h5 class="mb-0 para-ellipsis-1">Photography</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column gap-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <img class="img-fluid me-3 avatar-50 rounded-circle" src="{{asset('modules/blog/images/blog-avatar/02.png')}}" alt="01">
                                <div>
                            ...
                            <div class="d-flex">
                                <svg class="me-2" width="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div class="d-flex align-items-center">
                                <img class="img-fluid me-3 avatar-50 rounded-circle" src="{{asset('modules/blog/images/blog-avatar/03.png')}}" alt="01">
                                <div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div class="d-flex align-items-center">
                                <img class="img-fluid me-3 avatar-50 rounded-circle" src="{{asset('modules/blog/images/blog-avatar/04.png')}}" alt="01">
                                <div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div class="d-flex align-items-center">
                                <img class="img-fluid me-3 avatar-50 rounded-circle" src="{{asset('modules/blog/images/blog-avatar/05.png')}}" alt="01">
                                <div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div class="d-flex align-items-center">
                                <img class="img-fluid me-3 avatar-50 rounded-circle" src="{{asset('modules/blog/images/blog-avatar/06.png')}}" alt="01">
                                <div>
                                    <h6 class="mb-0">Jane Cooper</h6>
                                    <small class="text-ellipsis short-1">Lorem ipsum dolor consectetur sit amet.</small>
                                </div>
