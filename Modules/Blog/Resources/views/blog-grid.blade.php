<x-app-layout layout="blog" :assets="$assets ?? []" title='Blog Grid'>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 row-cols-xl-3">
        <div class="col">
        ...
        <div class="col">
            <x-modules.blog.widgets.blog-card masonrycard="true" classname="" blogimage="blog-categories/06.png" blogdate="02 Dec 2021" blogcontent="The Ultimate Travel Guide: What To Do, See & Eat."  blogcontent1="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Egestas dolor at feugiat in tempor maecenas placerat..."/>
        </div>
        <div class="col">
