<x-app-layout layout="blog" :assets="$assets ?? []" :isBanner="true" title='Blog Details'>
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body  card-thumbnail">
                    <div>
                        ...
                        <div class="d-flex gap-3">
                            <a href="{{route('blog.details')}}" class="iq-blog-adventure fs-6">Travel</a><span> | </span>
                            <a href="{{route('blog.details')}}" class="iq-blog-adventure text-primary fs-6">Jenny Wilson</a>
                        </div>
                    </div>
                    <img class="img-fluid rounded object-cover iq-blog-experience mt-3 mb-3 w-100" src="{{asset('modules/blog/images/blog-detail/01.png')}}" alt="01">
                ...
                <div class="card-body">
                    <div class="card shadow-none bg-transparent border mb-3">
                        <div class="card-body">
                            <div class="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                                <div>
                                    <img class="img-fluid object-contain avatar-120 rounded-0" src="{{asset('modules/blog/images/blog-avatar/07.png')}}" alt="01">
                                </div>
                    ...
                    <div class="card shadow-none bg-transparent border ms-5">
                        <div class="card-body">
                            <div class="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                                <div>
                                    <img class="img-fluid object-contain avatar-120 rounded-0" src="{{asset('modules/blog/images/blog-avatar/08.png')}}" alt="01">
                                </div>
                                <div class="ms-0 ms-sm-3">
                                    <div class="d-flex justify-content-between align-items-center my-2 my-lg-0">
                    ...
                    <div class="card shadow-none bg-transparent border mb-0">
                        <div class="card-body">
                            <div class="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                                <div>
                                    <img class="img-fluid object-contain avatar-120 rounded-0" src="{{asset('modules/blog/images/blog-avatar/07.png')}}" alt="01" loading="lazy" />
                                </div>
                                <div>
                                    <div class="d-flex justify-content-between align-items-center my-2 my-lg-0">
                                        <h6 class="mb-0">Jackson Jones</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"id="message" rows="4" class="form-control w-100"  placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit">
                                </div>
                            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-3 text-primary">Loren Banks</h6>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img class="img-fluid fit-img mb-4 object-cover iq-recent-post w-100" src="{{asset('modules/blog/images/blog-detail/05.png')}}" alt="01">
                    <div>
                        <small class="text-primary">April 19th 2021</small>
                        <a href="{{asset('modules/blog/images/blog-detail')}}" class="iq-title">
                            <h4 class="my-3">5 Beauty Essentials Everyone Should Have in Their Collection.</h4>
                        </a>
                        <div class="d-flex gap-2">
                            <a href="{{route('blog.index')}}"class="text-body" >Travel</a><span> | </span>
                            <a href="{{route('blog.index')}}" class="text-primary">Jenny Wilson</a>
                        </div>
                        <p class="pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ut eu morbi tincidunt </p>
            ...
            <div class="card-body">
                    ...
                    <ul class="iq-col-masonry logik-blogtag list-unstyled gap-3">
                        <li>
                            <a href="javascript:void(0)" class="bg-soft-primary rounded-pill iq-custom-badge">
                                <span>#Care</span>
                            </a>
                        </li>
                        <li>
