...
(function (jQuery) {
    ...
    if (document.querySelectorAll('[data-toggle="appointment_admin"]').length) {
      $('[data-toggle="appointment_admin"] tfoot th').each(function () {
        const title = $(this).attr('title');
        $(this).html(`<td><input type="text" class="form-control form-control-sm" placeholder="${title}" /></td>`);
      });
      $('[data-toggle="appointment_admin"]').DataTable({
          pageLength: 5,
