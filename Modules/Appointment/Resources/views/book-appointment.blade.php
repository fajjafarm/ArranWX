    ...
    <div class="row">
        <div class="col-12">
            ...
            <a href="#" class="btn btn-primary" role="button">{{__('appointment.back')}}</a>
                <button type="button" class="btn btn-primary ms-2 mt-2 mt-sm-0" data-bs-toggle="modal" data-bs-target="#add-appointment">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                                ...
                                <div class=" w-100" id="v-pills-tabContent">
                                    <div class="fade active show" id="-3">
                                        <div class="row g-3 align-items-center form-group">
                                            <div class="col-2">
                                                <label for="addtitle" class="col-form-label">{{__('appointment.title')}}</label>
                                            </div>
                                            <div class="col-10">
                                        ...
                                        <div class="row g-3 align-items-center form-group">
                                            <div class="col-2">
                                                <label for="nametitle" class="col-form-label">
                                                    ...
                                                    <path d="M3.09265 9.40427H20.9166" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    ...
                                                    <path d="M7.5579 13.3097H7.56717" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    ...
                                                    <path d="M7.5579 17.1962H7.56717" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            ...
                                            <div class="col-5">
                                                <input type="text" name="start_date"  id="nametitle" class="form-control date_flatpicker" placeholder="Select Start Date ">
                                            </div>
                                            <div class="col-5">
                                                <input type="text" name="end_date"  class="form-control date_flatpicker" placeholder="Select End Date ">
                                            </div>
                                        </div>
                                        <div class="row g-3 align-items-center form-group">
                                            <div class="col-2">
                                        ...
                                        <div class="row g-3 align-items-center form-group">
                                            <div class="col-2">
                                                <label class="col-form-label">
                                                    <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M13.7474 20.4429H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                        ...
                                                        <path d="M11.0208 6.00092L16.4731 10.188" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </svg>
                                                </label>
                                            </div>
                                            <div class="col-10">
                                                <select name="service" class="form-select choices-multiple-remove-button" multiple>
                                                    <option disabled>{{__('appointment.selectservice')}}</option>
                                                    <option value="Anesthetics">{{__('appointment.anesthetics')}}</option>
                                                    <option value="Cardiology">{{__('appointment.cardiology')}}</option>
                                                    <option value="ENT">{{__('appointment.ent')}}</option>
                                                    <option value="Gastroenterology">{{__('appointment.gastroenterology')}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row g-3 align-items-center form-group">
                    ...
                    <div class="d-flex align-items-center justify-content-center form-check">
                        ...
                        <label class="form-check-label ms-2" for="addconfirm2">{{__('appointment.confirm')}}</label>
                    </div>
                    </div>
                    <div class="modal-footer border-0">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">{{__('appointment.discard')}}</button>
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" name="save">{{__('appointment.save')}}</button>
                    </div>
                </div>
            </div>
        </div>
       <div class="modal fade" id="edit-appointment" data-bs-keyboard="true" tabindex="-1" aria-labelledby="edit-appointment" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class=" w-100" id="app-pills-tabContent">
                                <div class="fade active show" id="v-pills-home-3">
                                    <div class="row g-3 align-items-center form-group">
                                        <div class="col-2">
                                            <label for="title-drop-1" class="col-form-label">{{__('appointment.title')}}</label>
                                        </div>
                                        <div class="col-10">
                                            <input type="text" id="title-drop-1" class="form-control" aria-describedby="title-drop-1">
                                        </div>
                                    </div>
                                    <div class="row g-3 align-items-center form-group">
                                        <div class="col-2">
                                        ...
                                        <div class="col-5">
                                            <input type="text" name="start_date"  class="form-control date_flatpicker"  placeholder="Select Start Date ">
                                        </div>
                                         <div class="col-5">
                                            <input type="text" name="end_date"  class="form-control date_flatpicker"  placeholder="Select End Date ">
                                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex pb-4">
                        <div>
                            <img class="img-fluid rounded" src="{{asset('modules/appointment/images/users/01.png')}}" alt="users img">
                        </div>
                        <div class="d-flex justify-content-between align-items-center flex-grow-1">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <p class="text-primary mb-0">3.5</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex">
                        <div>
                            <img class="img-fluid rounded" src="{{asset('modules/appointment/images/users/02.png')}}" alt="users img">
                        </div>
                        <div class="d-flex justify-content-between align-items-center flex-grow-1">
                            <div class="ms-3">
