                ...
                <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center align-self-center mt-2 mt-sm-0">
                        <div class="d-flex align-items-center text-primary">
                            ...
                            <div class="ms-2">
                            <span class="text-secondary">{{__('appointment.booked')}}</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center ms-3 text-info">
                            ...
                            <div class="ms-2">
                            <span class="text-secondary">{{__('appointment.cancelled')}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="dropdown">
                        <a href="#" class="text-secondary dropdown-toggle" id="dropdownMenuButton22" data-bs-toggle="dropdown" aria-expanded="false">This year</a>
                        ...
                        <div class="col-md-5 col-sm-12">
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center gap-2">
                                    <svg width="12" class="text-primary" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="d-flex align-items-center mt-3 gap-2">
                                    <svg width="12" class="text-info" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="6.5" cy="7" r="6.5" fill="currentColor"/>
                                    </svg>
                                    <div class="ms-2">
            ...
            <div class="card">
                ...
                <div class="px-0 card-body">
                    <div class="table-responsive">
                        <table class="table-striped table  table py-3" role="grid" data-toggle="appointment_admin">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded img-fluid avatar-40 me-3" src="{{asset('modules/appointment/images/avatars/02.png')}}" alt="profile">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded img-fluid avatar-40 me-3" src="{{asset('modules/appointment/images/avatars/03.png')}}" alt="profile">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded img-fluid avatar-40 me-3" src="{{asset('modules/appointment/images/avatars/04.png')}}" alt="profile">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded img-fluid avatar-40 me-3" src="{{asset('modules/appointment/images/avatars/05.png')}}" alt="profile">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded img-fluid avatar-40 me-3" src="{{asset('modules/appointment/images/avatars/01.png')}}" alt="profile">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex profile-media align-items-top">
                        ...
                        <div class="ms-4">
                            <h6 class="mb-1 ">Cameron Williamson - <span class="text-primary">{{__('appointment.dentist')}}</span></h6>
                    ...
                    <div class="d-flex profile-media align-items-top">
                        <div class="mt-1 profile-dots-pills border-primary"></div>
                        <div class="ms-4">
                            <h6 class="mb-1 ">Brooklyn Simmons - <span class="text-primary">{{__('appointment.orthopedic')}}</span></h6>
                    ...
                    <div class="d-flex profile-media align-items-top">
                        <div class="mt-1 profile-dots-pills border-primary"></div>
                        <div class="ms-4">
                            <h6 class="mb-1 ">Leslie Alexander - <span class="text-primary">{{__('appointment.neurology')}}</span></h6>
                    ...
                    <div class="d-flex profile-media align-items-top">
                        <div class="mt-1 profile-dots-pills border-primary"></div>
                        <div class="ms-4">
                            <h6 class="mb-1 ">Robbin Doe - <span class="text-primary">{{__('appointment.ent')}}</span></h6>
                    ...
                    <div class="mb-1 d-flex profile-media align-items-top">
                        <div class="mt-1 profile-dots-pills border-primary"></div>
                        <div class="ms-4">
                            <h6 class="mb-1 ">Jane Cooper - <span class="text-primary">{{__('appointment.cardiologist')}}</span></h6>
