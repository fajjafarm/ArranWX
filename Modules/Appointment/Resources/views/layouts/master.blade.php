...
<head>
    ...
    <title data-setting="app_name" data-rightJoin=" Pro Appointment | Responsive Bootstrap 5 Admin Dashboard Template">
        {{ env('APP_NAME') }} Pro Appointment | Responsive Bootstrap 5 Admin Dashboard Template</title>
    ...
    <meta name="keywords"
        content="premium, admin, dashboard, template, bootstrap 5, clean ui, hope ui, admin dashboard,responsive dashboard, optimized dashboard, Appointment app">
    <meta name="author" content="Iqonic Design">
    <meta name="DC.title"
        content="{{ env('APP_NAME') }} Pro Appointment | Responsive Bootstrap 5 Admin Dashboard Template">
    <!-- Style Link start -->
...
<body class="light theme-style-light theme-color-default null" data-aos-easing="ease" data-aos-duration="700"
    ...
    <!-- Sidebar Start -->
    @include('appointment::partials.sidebar')
    <!-- Sidebar End -->
    ...
    <main class="main-content">
        <div class="position-relative @if ($isBanner == 'true') iq-banner @endif">
            ...
            @if ($isBanner == 'true')
                <!-- Header Banner Start-->
                <x-modules.appointment.widgets.subheader />
                <!-- Header Banner End-->
            @endif
        </div>
        <!-- Page Content Start-->
