<x-app-layout layout="appointment" :assets="$assets ?? []" title="doctor-visit" :isSignaturePad="true" isFlatpicker="true" isSelect2="true">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                    ...
                    <table class="table-striped table table py-3" role="grid" data-toggle="doctor_visit"  >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img src="{{asset('modules/appointment/images/signature/01.svg')}}" class="avatar-50" alt="sign"></td>
                            </tr>
                            <tr>
                                ...
                                <td><img src="{{asset('modules/appointment/images/signature/02.svg')}}" class="avatar-50" alt="sign"></td>
                            </tr>
                            <tr>
                                ...
                                <td>06:00 PM</td>
                                <td><div class="text-white badge rounded-pill bg-danger">Doctor Out</div></td>
                                <td><img src="{{asset('modules/appointment/images/signature/03.svg')}}" class="avatar-50" alt="sign"></td>
                            </tr>
                            <tr>
                                ...
                                <td>08:00 PM</td>
                                <td><div class="text-white badge rounded-pill bg-success">Doctor In</div></td>
                                <td><img src="{{asset('modules/appointment/images/signature/04.svg')}}" class="avatar-50" alt="sign"></td>
                            </tr>
                            <tr>
                                ...
                                <td>12:00 PM</td>
                                <td><div class="text-white badge rounded-pill bg-success">Doctor In</div></td>
                                <td><img src="{{asset('modules/appointment/images/signature/05.svg')}}" class="avatar-50" alt="sign"></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
