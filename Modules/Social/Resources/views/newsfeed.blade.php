...
<div class="row">
        ...
        <div id="sidebar-left-social" class="iq-sidebar-left-social">
            <div class="sidebar__inner">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="mb-3">{{__('social.stories')}}</h5>
                        <div class="d-flex align-items-center mb-4 gap-3">
                            <img src="{{asset('modules/social-app/images/avatar/31.png')}}" class="img-fluid avatar-48 rounded-circle" alt="profile-image">
                            <div>
                        ...
                        <div class="iq-social-user-details">
                            <x-modules.social.widgets.icon-widget userName="Sepid" userAvatar="avatar/01.png" userComment="Liked Your Photo" image="true" postImg="newsfeed/06.png"/>
                            <x-modules.social.widgets.icon-widget userName="Rokni" userAvatar="avatar/09.png" userComment="Started Following You" addBtn="true"/>
                            <x-modules.social.widgets.icon-widget userName="Arman" userAvatar="avatar/15.png" userComment="Liked Your Photo" image="true" postImg="newsfeed/05.png"/>
                            <x-modules.social.widgets.icon-widget userName="Medra" userAvatar="avatar/23.png" userComment="Started Following You" addBtn="true"/>
                            <x-modules.social.widgets.icon-widget userName="Afshin" userAvatar="avatar/26.png" userComment="Liked Your Photo" image="true" postImg="newsfeed/07.png"/>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between flex-grow-1">
                            ...
                            <div class="btn btn-sm btn-soft-primary">{{__('social.website')}}</div>
                            <div class="btn btn-sm btn-soft-primary">{{__('social.product')}}</div>
                            </div>
                        </div>
                        <div class="iq-grid-explore d-grid mt-3">
                            <a class="iq-item-col-end rounded" data-fslightbox="gallery" href="{{asset('modules/social-app/images/newsfeed/03.png')}}">
                                <img src="{{asset('modules/social-app/images/newsfeed/03.png')}}" class="img-fluid rounded" alt="profile-image" loading="lazy">
                            </a>
                            <a class="iq-item-row-end rounded" data-fslightbox="gallery" href="{{asset('modules/social-app/images/newsfeed/11.png')}}">
                                <img src="{{asset('modules/social-app/images/newsfeed/08.png')}}" class="img-fluid rounded" alt="profile-image" loading="lazy">
                            </a>
                            <a class="iq-item-row-end rounded" data-fslightbox="gallery" href="{{asset('modules/social-app/images/newsfeed/04.png')}}">
                                <img src="{{asset('modules/social-app/images/newsfeed/09.png')}}" class="img-fluid rounded" alt="profile-image" loading="lazy">
                            </a>
                            <a class="iq-item-row-end rounded" data-fslightbox="gallery" href="{{asset('modules/social-app/images/newsfeed/09.png')}}">
                                <img src="{{asset('modules/social-app/images/newsfeed/10.png')}}" class="img-fluid rounded" alt="profile-image" loading="lazy">
                            </a>
                            <a class="iq-item-row-end rounded" data-fslightbox="gallery" href="{{asset('modules/social-app/images/newsfeed/10.png')}}">
                                <img src="{{asset('modules/social-app/images/newsfeed/11.png')}}" class="img-fluid rounded" alt="profile-image" loading="lazy">
                            </a>
                            <a class="iq-item-col-end rounded" data-fslightbox="gallery" href="{{asset('modules/social-app/images/newsfeed/02.png')}}">
                                <img src="{{asset('modules/social-app/images/newsfeed/02.png')}}" class="img-fluid rounded" alt="profile-image" loading="lazy">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-6 col-lg-6">
            ...
            <div class="card-body">
                <div class="border-bottom">
                    <div class="d-flex align-items-center mb-3 gap-3">
                        <img class="img-fluid rounded-circle avatar-60 p-1 border border-2 border-primary border-dotted" src="{{asset('modules/social-app/images/avatar/22.png')}}" alt="" loading="lazy" />
                 ...
                 <div class="d-flex align-items-center mt-3">
                    <div class="btn btn-sm btn-soft-light d-flex align-items-center gap-2">
                    ...
                    <div class="btn btn-sm btn-soft-light mx-3 d-flex align-items-center gap-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="user-post">
                    <img src="{{asset('modules/social-app/images/app/01.png')}}" class="img-fluid rounded" alt="post-image" data-bs-toggle="modal" data-bs-target="#image-modal" role="button" loading="lazy">
                </div>
                <div class="comment-area pt-3">
                    <x-modules.social.widgets.like-share id="01" noLikes="120" noComments="02" noShare="15" />
                    <hr>
        ...
        <div class="card">
            <x-modules.social.widgets.post-header id="02" userName="Ella Martina" postStatus="Updated Her Status" postDuration="5 hrs" userprofile="avatar/24.png" />
            <div class="card-body">
                <p>“Essentials to happiness in this life are something to do, something to love, and something to hope for.”</p>
                <div class="comment-area pt-3">
                    <x-modules.social.widgets.like-share id="02" noLikes="15" noComments="20" noShare="04" />
                    <hr>
                    <ul class="list-inline mt-4 mb-0">
                        <li class="mb-0">
                            <x-modules.social.widgets.friend-comment id="02" userName="Larry Robbins" userComment="So True!!" commentDuration="5 Min Ago" userImage="avatar/11.png"/>
                        </li>
                    </ul>
                    <x-modules.social.widgets.comment-form-control placeholder="Enter Your Comment Here..."/>
                </div>
    ...
    <div class="col-xl-3 col-lg-3">
            ...
            <div class="card-body">
                ...
                <div class="iq-social-message-newsfeed mt-3">
                    <nav class="tab-bottom-bordered">
                        <div class="mb-0 nav nav-tabs flex-nowrap justify-content-between" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="pills-activeorders-tab1" data-bs-toggle="pill" data-bs-target="#pills-activeorders" role="tab" aria-controls="pills-activeorders"  aria-selected="true">
                                <span class="iq-socail-message-tab-text">
                                    Archive
                                </span>
                                <span class="iq-socail-message-tab-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Primary">
                                    <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="nav-link" id="pills-cancelledorders-tab1" data-bs-toggle="pill" data-bs-target="#pills-cancelledorders" role="tab" aria-controls="pills-cancelledorders" aria-selected="false">
                                <span class="iq-socail-message-tab-text">
                                    Recent
                                </span>
                                <span class="iq-socail-message-tab-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="General">
                                    <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="nav-link" id="pills-mytrades-tab1" data-bs-toggle="pill" data-bs-target="#pills-mytrades" role="tab" aria-controls="pills-mytrades" aria-selected="false">
                                <span class="iq-socail-message-tab-text">
                                    {{__('social.new')}}
                                </span>
                                <span class="iq-socail-message-tab-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Requests">
                                    <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="tab-pane fade show active" id="pills-activeorders" role="tabpanel" >
                        <div class="tabs-panel">
                            <ul class="list-unstyled mb-0">
                                <li class="pt-3">
                                    <x-modules.social.widgets.icon-widget userName="Arman Rokni" userAvatar="avatar/11.png" userComment="Active 30m"/>
                                </li>
                                <li class="pt-3">
                                    <x-modules.social.widgets.icon-widget userName="MD Alidoost" userAvatar="avatar/12.png" userComment="Active 30m"/>
                                </li>
                                <li class="pt-3">
                                    <x-modules.social.widgets.icon-widget userName="Afshin Rotni" userAvatar="avatar/13.png" userComment="Active 30m"/>
                                </li>
                                <li class="pt-3">
                                    <x-modules.social.widgets.icon-widget userName="Salman Shaha" userAvatar="avatar/14.png" userComment="Active 30m"/>
                                </li>
                                <li class="pt-3">
                                    <x-modules.social.widgets.icon-widget userName="Vida Lakhani" userAvatar="avatar/09.png" userComment="Active 30m"/>
                                </li>
                                <li class="pt-3">
                                    <x-modules.social.widgets.icon-widget userName="Goutham" userAvatar="avatar/10.png" userComment="Active 30m"/>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="iq-social-user-details">
                    <x-modules.social.widgets.suggested-user userName="Vida Lakhani" userAvatar="avatar/09.png" userComment="Suggested For you"/>
                    <x-modules.social.widgets.suggested-user userName="Arman Rokni" userAvatar="avatar/11.png" userComment="Suggested For you"/>
                    <x-modules.social.widgets.suggested-user userName="Salman Shaha" userAvatar="avatar/14.png" userComment="Followed By Mr. Ali"/>
                    <x-modules.social.widgets.suggested-user userName="Afshin Rotni" userAvatar="avatar/13.png" userComment="Followed By Afshint"/>
                    <x-modules.social.widgets.suggested-user userName="MD Ali" userAvatar="avatar/12.png" userComment="Followed By Vida"/>
                </div>
            </div>
        </div>
    </div>
