<aside class="sidebar sidebar-base navs-rounded-all left-bordered"  data-toggle="main-sidebar" data-sidebar="responsive">
   ...
   <div class="sidebar-body pt-0 data-scrollbar">
        <x-modules.social.widgets.sidebar-profile-card />
        <hr class="hr-horizontal">
        <div class="sidebar-list">
            @include('social::partials.vertical_navbar')
        </div>
   </div>
