...
class GenerateMenu
{
    ...
    public function handle(Request $request, Closure $next)
    {
        \Menu::make('HopeUIMenu', function ($menu) use($request) {
            ...
            /* Start If Condition */
            if(str_contains($request->path(), 'social')) {
                // Static Social
                $this->staticMenu($moduleMenu, ['title' => 'SOCIAL', 'order' => 405]);
            ...
            /* Close If Condition */
                ...
                // Submenu-Friends - Child
                $this->childMain($friend, [
                    'shortTitle' => 'F',
                    'title' => 'Friend List',
                    'route' => 'social.friendlist',
                    'active' => 'social/friend-list'
                ]);
                $this->childMain($friend, [
                    'shortTitle' => 'F',
                    'title' => 'Friend Request',
                    'route' => 'social.friendrequest',
                    'active' => 'social/friend-request'
                ]);
                $this->childMain($friend, [
                    'shortTitle' => 'F',
                    'title' => 'Friend Profile',
                    'route' => 'social.friendprofile',
                    'active' => 'social/friend-profile'
                ]);

                // Profile
                $profile = $this->parentMenu($moduleMenu, [
                    'icon' => '<svg class="icon-18" width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.997 15.1746C7.684 15.1746 4 15.8546 4 18.5746C4 21.2956 7.661 21.9996 11.997 21.9996C16.31 21.9996 19.994 21.3206 19.994 18.5996C19.994 15.8786 16.334 15.1746 11.997 15.1746Z" fill="currentColor"></path><path opacity="0.4" d="M11.9971 12.5838C14.9351 12.5838 17.2891 10.2288 17.2891 7.29176C17.2891 4.35476 14.9351 1.99976 11.9971 1.99976C9.06008 1.99976 6.70508 4.35476 6.70508 7.29176C6.70508 10.2288 9.06008 12.5838 11.9971 12.5838Z" fill="currentColor"></path></svg>',
                    'title' => 'Profile',
                    'nickname' => 'profile',
                    'parent' => '#social',
                    'order' => 415
                ...
                // Submenu-Profile - Child
                $this->childMain($profile, [
                    'shortTitle' => 'P',
                    'title' => 'Profile Badges',
                    'route' => 'social.profilebadges',
                    'active' => 'social/profile-badges'
                ]);
                $this->childMain($profile, [
                    'shortTitle' => 'P',
                    'title' => 'Profile Images',
                    'route' => 'social.profileimages',
                    'active' => 'social/profile-images'
                ]);
                $this->childMain($profile, [
                    'shortTitle' => 'P',
                    'title' => 'Profile Video',
                    'route' => 'social.profilevideo',
                    'active' => 'social/profile-video'
                ]);
                $this->childMain($profile, [
                    'shortTitle' => 'B',
                    'title' => 'Brithday',
                    'route' => 'social.birthday',
                    'active' => 'social/birthday'
                ]);
                $this->childMain($profile, [
                    'shortTitle' => 'N',
                    'title' => 'Notification',
                    'route' => 'social.notification',
                    'active' => 'social/notification'
                ]);
                $this->childMain($profile, [
                    'shortTitle' => 'A',
                    'title' => 'Account Setting',
                    'route' => 'social.accountsetting',
                    'active' => 'social/account-setting'
                ]);

                // Event
                $event = $this->parentMenu($moduleMenu, [
                ...
                $this->childMain($group, [
                    'shortTitle' => 'G',
                    'title' => 'Group Detail',
                    'route' => 'social.groupdetail',
                    'active' => 'social/group-detail'
                ]);
