...
<div class="border-bottom pb-3 d-flex align-items-center justify-content-between">
    ...
    <h4 class="py-3">{{__('filemanager.recently_viewed')}}</h4>
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
        ...
        <div class="col">
            <x-modules.filemanager.document imageDate="Dec 13, 2020" imgName="xyz-25783.xlsx" imgLink="2 days ago" imgChange="ppt.svg" imgMb="12mb" docType="PPTX" docName="demo.pptx"/>
        </div>
        <div class="col">
        ...
        <div class="col">
            <x-modules.filemanager.document imageDate="Dec 13, 2020" imgName="abc-123472578.pdf" imgLink="just now" imgChange="ppt.svg" imgMb="58kb" docType="PPTX" docName="demo.pptx"/>
        </div>
        <div class="col">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
        ...
        <div class="col">
            <x-modules.filemanager.document imageDate="Dec 13, 2020" imgName="CV-25783.doc" imgLink="2 days ago" imgChange="ppt.svg" imgMb="2mb" docType="PPTX" docName="demo.pptx"/>
        </div>
        <div class="col">
        ...
        <div class="col">
            <x-modules.filemanager.document imageDate="Dec 13, 2020" imgName="abc-25783.doc" imgLink="2 days ago" imgChange="ppt.svg" imgMb="20mb" docType="PPTX" docName="demo.pptx"/>
        </div>
        <div class="col">
