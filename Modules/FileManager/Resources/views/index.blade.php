                    ...
                    <div class="d-flex flex flex-column gap-4">
                        ...
                        <div class="w-100">
                            ...
                            <div class="shadow-none progress bg-soft-primary w-100" style="height: 8px">
                                <div class="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex gap-3">
                        ...
                        <div class="w-100">
                            ...
                            <div class="shadow-none progress bg-soft-primary w-100" style="height: 8px">
                                <div class="progress-bar bg-success" data-toggle="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex gap-3">
                        ...
                        <div class="w-100">
                            ...
                            <div class="shadow-none progress bg-soft-primary w-100" style="height: 8px">
                                <div class="progress-bar bg-warning" data-toggle="progress-bar" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="d-flex flex-wrap justify-content-between">
                        ...
                        <div class="d-flex mt-2">
                            <div class="dropdown">
                                <a href="#" class="text-secondary dropdown-toggle" id="dropdownMenuButton22" data-bs-toggle="dropdown" aria-expanded="false">{{__('filemanager.year')}}</a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton22" style="">
                                <li><a class="dropdown-item" href="#">{{__('filemanager.action')}}</a></li>
                                <li><a class="dropdown-item" href="#">{{__('filemanager.another')}}</a></li>
                                <li><a class="dropdown-item" href="#">{{__('filemanager.else_here')}}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body  d-flex gap-4 flex-column">
                    <div class="d-flex">
                        ...
                        <div class="drive-progress d-flex align-items-center">
                            <div class="shadow-none progress bg-soft-primary w-50" style="height: 4px">
                            ...
                            <svg width="40" viewBox="0 0 24 24" class="text-primary" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="drive-progress d-flex align-items-center">
                            <div class="shadow-none progress bg-soft-primary w-50" style="height: 4px">
                                <div class="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="73" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{route('file-manager.documents')}}" class="text-primary">{{__('filemanager.view')}}</a>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <span class="avatar-40 bg-soft-primary rounded-pill">
                                                ...
                                                <h6 class="ms-3 mb-0">Marcus Family.jpg</h6>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h6 class="ms-3 mb-0">Work.Doc</h6>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h6 class="ms-3 mb-0">Apha.mkv</h6>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h6 class="ms-3 mb-0">SVG Logo.png </h6>
                                            </div>
                                        </td>
                                        <td>
                        ...
                        <div class="card-body">
                            <div class="border-bottom">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('modules/file-manager/images/10.png')}}" class="img-fluid avatar-30" alt="">
                                ...
                                <div>
                                    ...
                                    <div class="shadow-none progress bg-soft-primary w-100 mt-2" style="height: 8px">
                            ...
                            <div class="border-bottom">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('modules/file-manager/images/9.png')}}" class="img-fluid avatar-30" alt="">
                            ...
                            <div class="border-bottom">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('modules/file-manager/images/17.png')}}" class="img-fluid avatar-30" alt="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{asset('modules/file-manager/images/18.png')}}" class="img-fluid" alt="">
                                <h5 class="my-4">{{__('filemanager.upgrade')}}</h5>
                                <div class="d-flex justify-content-center ms-2">
                                    <button type="submit" class="btn btn-primary">{{__('filemanager.buy')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
