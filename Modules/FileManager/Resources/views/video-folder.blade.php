<x-app-layout layout="filemanager" :assets="$assets ?? []" title="Video " isFslightbox="true">
    ...
    @push('head')
    <link rel="stylesheet" href="{{asset('vendor/uppy/uppy.min.css')}}"></link>
    @endpush

    @push('scripts')
    <script src="{{asset('vendor/uppy/uppy.min.js')}}"></script>
    <script src="{{asset('js/plugins/uppy.js')}}"></script>
    @endpush
</x-app-layout>
