<x-app-layout layout="filemanager" :assets="$assets ?? []" title="All-files" :isSweetalert="true" isUppy="true">
...
<div class="border-bottom pb-3 d-flex align-items-center justify-content-between">
            ...
            <button class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModal" type="submit">
                <span class="d-flex justify-content-center ">
                    ...
                    <span class="ms-3 mb-0">Add Files</span>
                </span>
            </button>
        </div>
    <h4 class="py-3">Documents</h4>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
            ...
            <div class="col">
                <x-modules.filemanager.document imageDate="Dec 13, 2020" imgName="xyz-25783.xlsx" imgLink="2 days ago" imgChange="excel.svg" imgMb="12mb" docType="XLSX" docName="demo.xlsx"/>
            </div>
        </div>
