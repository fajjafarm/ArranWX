<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='Product Detail' :isSweetalert="true">
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                            ...
                            <div class="slider__flex">
                                <div class="slider__col">
                                    <div class="slider__prev">
                                        <svg width="32" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path  d="M-0.000198364 10.0001C-0.000198364 4.48509 4.4858 9.15527e-05 9.9998 9.15527e-05C15.5138 9.15527e-05 19.9998 4.48509 19.9998 10.0001C19.9998 15.5141 15.5138 20.0001 9.9998 20.0001C4.4858 20.0001 -0.000198364 15.5141 -0.000198364 10.0001Z" fill="currentColor"/>
                                            <path d="M5.7791 11.4425C5.7791 11.2515 5.8521 11.0595 5.9981 10.9135L9.4681 7.42649C9.6091 7.28549 9.8001 7.20649 10.0001 7.20649C10.1991 7.20649 10.3901 7.28549 10.5311 7.42649L14.0031 10.9135C14.2951 11.2065 14.2951 11.6805 14.0011 11.9735C13.7071 12.2655 13.2321 12.2645 12.9401 11.9715L10.0001 9.01849L7.0601 11.9715C6.7681 12.2645 6.2941 12.2655 6.0001 11.9735C5.8521 11.8275 5.7791 11.6345 5.7791 11.4425Z" fill="#ffffff"/>
                                        </svg>
                                    </div>
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('modules/e-commerce/images/product-detail/2.png')}}"  alt=""/>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('modules/e-commerce/images/product-detail/3.png')}}"  alt=""/>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('modules/e-commerce/images/product-detail/4.png')}}" alt=""/>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('modules/e-commerce/images/product-detail/5.png')}}" alt=""/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="slider__next">
                                        <svg width="32" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path  d="M20.0002 9.99991C20.0002 15.5149 15.5142 19.9999 10.0002 19.9999C4.48618 19.9999 0.000183105 15.5149 0.000183105 9.99991C0.000183105 4.48591 4.48618 -9.15527e-05 10.0002 -9.15527e-05C15.5142 -9.15527e-05 20.0002 4.48591 20.0002 9.99991Z" fill="currentColor"/>
                                            <path d="M14.2209 8.55751C14.2209 8.74851 14.1479 8.94051 14.0019 9.08651L10.5319 12.5735C10.3909 12.7145 10.1999 12.7935 9.99989 12.7935C9.80089 12.7935 9.60989 12.7145 9.46889 12.5735L5.99689 9.08651C5.70489 8.79351 5.70489 8.31951 5.99889 8.02651C6.29289 7.73451 6.76789 7.73551 7.05989 8.02851L9.99989 10.9815L12.9399 8.02851C13.2319 7.73551 13.7059 7.73451 13.9999 8.02651C14.1479 8.17251 14.2209 8.36551 14.2209 8.55751Z" fill="white"/>
                                        </svg>
                                    </div>
                                </div>
                                <div class="slider__images">
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="slider__image">
                                                    <img src="{{asset('modules/e-commerce/images/product-detail/1.png')}}" alt=""/>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="slider__image">
                        ...
                        <div class="border-bottom">
                            <div class="d-flex flex-column align-content-between justify-items-center mb-3">
                                <div class="d-flex justify-content-between mb-2">
                                    <h2 class="mb-0">{{__('e-commerce.leather_bags')}}</h2>
                            ...
                            <div class="d-flex my-4">
                                <h4 class="mb-0"> {{__('e-commerce.price')}}:</h4>
                                <h4 class="text-primary mb-0 ms-2">$45.00</h4>
                            </div>
                        </div>
                        <div class="border-bottom">
                            <p class="py-4 mb-0">{{__('e-commerce.content')}}</p>
                        </div>
                        <div class="d-flex flex-column py-4">
                            <div class="d-flex align-items-center mb-3">
                                <span class="text-dark">{{__('e-commerce.free_del')}}</span>
                                <span class="text-primary  ms-2">{{__('e-commerce.thurs')}} ,Dec 28</span>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <span class="text-dark">{{__('e-commerce.fastest_del')}}</span>
                                <span class="text-primary  ms-2">{{__('e-commerce.today')}}</span>
                            </div>
                        </div>
                        <div>
                            <div class="btn-group iq-qty-btn mb-3" data-qty="btn" role="group">
                                ...
                                <input type="text" class="btn btn-sm border-light input-display form-control" data-qty="input" value="0" title="Qty" readonly>
                            ...
                            <div class="d-flex py-4 flex-wrap gap-4">
                                <a href="{{route('e-commerce.order-process')}}" class="btn btn-warning d-flex align-items-center gap-2 ">
                                ...
                                <button class="btn btn-primary d-flex align-items-center cart-btn gap-2">
                                    ...
                                    {{__('e-commerce.add_to_cart')}}
                                </button>
                                <a href="#" class="btn btn-info d-flex align-items-center wishlist-btn gap-2">
                                    <span class="btn-inner d-flex ">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
