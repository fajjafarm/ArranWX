<x-app-layout layout="e-commerce" :assets="$assets ?? []" title="Wishlist" isSweetalert="true">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-3 mt-4 ">
        ...
        <x-modules.e-commerce.widgets.wishlist-card images="wishlist/5.png" itemsname="{{__('e-commerce.leather_bags')}}" ratings="4.2" productprice="$10.00" productoffer="50% Off" productliked="384" />
        ...
        <x-modules.e-commerce.widgets.wishlist-card images="wishlist/2.png" itemsname="{{__('e-commerce.shoe')}}" ratings="4.5" productprice="$56.00" productoffer="15% Off" productliked="412"/>
