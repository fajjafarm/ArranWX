<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='Shop Main' :isNoUISlider="true" :isSweetalert="true">
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-grid-view" role="tabpanel" aria-labelledby="grid-view-tab">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
                        ...
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="mb-0" productname="{{__('e-commerce.biker’s_jacket')}}" statusdetails="Sold" statuscolor="warning" productimage="product/04.png" productrating="3.5" productprice="$56.00"/>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="" productname="{{__('e-coomerce.pink_triusers')}}" statusdetails="New" statuscolor="primary" productimage="product/07.png" productrating="3.5" productprice="$56.00"/>
                        </div>
                        <div class="col">
