<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='360 Product Detail' isSweetalert="true">
    @push('scripts')
    <script>
            window.CI360 = {
                notInitOnLoad: true
    ...
    <script src="{{asset('js/plugins/js-360-view.min.js')}}"></script>
    @endpush
    <div class="card">
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="product-slider slider-circle-btn">
                        <div  class="swiper-container gallery-top text-end">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img alt="product-15" src="{{asset('modules/e-commerce/images/bag-product/10.png')}}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-16" src="{{asset('modules/e-commerce/images/bag-product/20.png')}}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-17" src="{{asset('modules/e-commerce/images/bag-product/30.png')}}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-17" src="{{asset('modules/e-commerce/images/bag-product/40.png')}}" />
                                </div>
                                    <div class="swiper-slide">
                                    <img alt="product-17" src="{{asset('modules/e-commerce/images/bag-product/50.png')}}" />
                                </div>
                                    <div class="swiper-slide">
                                    <img alt="product-17" src="{{asset('modules/e-commerce/images/bag-product/60.png')}}" />
                                </div>
                                    <div class="swiper-slide">
                                    <img alt="product-17" src="{{asset('modules/e-commerce/images/bag-product/90.png')}}" />
                                </div>
                            </div>
                        ...
                        <div  class="swiper-container gallery-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img alt="product-19" src="{{asset('modules/e-commerce/images/bag-product/10.png')}}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-20" src="{{asset('modules/e-commerce/images/bag-product/20.png')}}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-21" src="{{asset('modules/e-commerce/images/bag-product/30.png')}}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-22" src="{{asset('modules/e-commerce/images/bag-product/40.png')}}" />
                                </div>
                                    <div class="swiper-slide">
                                    <img alt="product-19" src="{{asset('modules/e-commerce/images/bag-product/50.png')}}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-20" src="{{asset('modules/e-commerce/images/bag-product/60.png')}}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-20" src="{{asset('modules/e-commerce/images/bag-product/90.png')}}" />
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal fade " id="product-viewer360" tabindex="-1" >
                    <div class="modal-dialog modal-xl" style="max-width: 1400px;">
                        <div class="modal-content  bg-transparent border-0 shadow-none">
                            <div class="model-header text-end">
                                <button type="button" class="btn btn-light m-2" aria-label="Close" data-bs-dismiss="modal">{{__('e-commerce.close')}}</button>
                            </div>
                            <div class="modal-body">
                                <div class="row vh-80 align-items-center">
                                    <div class="col-12">
                                        <div class="d-flex flex-column">
                                            <div class="cloudimage-360" data-folder="{{asset('modules/e-commerce/images/bag-product/')}}/" data-filename="{index}.png" data-amount-x="120" data-hide-360-logo="true" data-pointer-zoom="2"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="border-bottom">
                        <div class="d-flex flex-column align-content-between justify-items-center mb-3">
                            <div class="d-flex justify-content-between mb-2">
                                <h2 class="mb-0">Leather Bags</h2>
                                <div class="d-flex justify-content-end ">
                                    <button class="btn btn-soft-primary btn-icon rounded-pill" href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#share-btn" aria-controls="share-btn" role="button">
                                        <span class="btn-inner">
                            ...
                            <div class=" d-flex align-items-center w-100">
                                <svg class="icon-25" xmlns="http://www.w3.org/2000/svg" width="25" viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="d-flex my-4">
                            ...
                            <h4 class="text-primary mb-0 ms-2">$45.00</h4>
                        </div>
                    </div>
                    <div class="border-bottom">
                    ...
                    <div class="d-flex flex-column py-4">
                        <div class="d-flex align-items-center mb-3">
                            <span class="text-dark">Free Delivery:</span>
                            <span class="text-primary  ms-2">Thursday , Oct 28</span>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="btn-group iq-qty-btn mb-3" data-qty="btn" role="group">
                        ...
                        <div class="d-flex py-4 flex-wrap gap-4">
                            ...
                            <button class="btn btn-primary d-flex gap-2 cart-btn align-items-center cart-btn">
                                <span class="btn-inner d-flex">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                        <div class="d-flex flex-column">
                            ...
                            <div class="row row-cols-2 row-cols-lg-5 py-3">
                                <div class="col">
                                    <img src="{{asset('modules/e-commerce/images/bag-product/10.png')}}" alt="product-details" class="img-fluid iq-product-img rounded-2 w-100 ">
                                </div>
                                <div class="col">
                                    <img src="{{asset('modules/e-commerce/images/bag-product/11.png')}}" alt="product-details" class="img-fluid iq-product-img rounded-2  w-100 ">
                                </div>
                                <div class="col">
                                    <img src="{{asset('modules/e-commerce/images/bag-product/12.png')}}" alt="product-details" class="img-fluid iq-product-img rounded-2 w-100  ">
                                </div>
                                <div class="col">
                                    <img src="{{asset('modules/e-commerce/images/bag-product/13.png')}}" alt="product-details" class="img-fluid iq-product-img rounded-2  w-100 ">
                                </div>
                                <div class="col">
                                    <img src="{{asset('modules/e-commerce/images/bag-product/14.png')}}" alt="product-details" class="img-fluid iq-product-img rounded-2  w-100  ">
                                </div>
                            </div>
    ...
    <div class="row row-cols-1">
        <div class="d-flex py-4">
            <h4 class="mb-0">{{__('e-commerce.similar_prod')}}</h4>
        </div>
