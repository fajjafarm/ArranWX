<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='Shop - Right Filter' :isNoUISlider="true" :isSweetalert="true">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-grid-view" role="tabpanel" aria-labelledby="grid-view-tab">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="mb-0" productname="{{__('e-commerce.shoe')}}" statusdetails="" statuscolor="" productimage="product/02.png" productrating="3.5" productprice="$56.00"/>
                        </div>
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="mb-0" productname="{{__('e-commerce.biker’s_jacket')}}" statusdetails="Sold" statuscolor="warning" productimage="product/04.png" productrating="3.5" productprice="$65.00"/>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="" productname="{{__('e-commerce.pink_triusers')}}" statusdetails="New" statuscolor="primary" productimage="product/07.png" productrating="3.5" productprice="$65.00"/>
                        </div>
                        <div class="col">
                ...
                <div class="tab-pane fade" id="pills-list-view" role="tabpanel" aria-labelledby="list-view-tab">
                    <div class="row row-cols-1">
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card-list-view productname="{{__('e-commerce.shoe')}}Casual Shoes" productimage="product/02.png" productrating="3.5" productprice="$56.00" statuscolor="success" statusidentity="In Stock" deliverydate="Thu Jan 30" replacetime="10" />
                            ...
                            <x-modules.e-commerce.widgets.product-card-list-view productname="{{__('e-commerce.pink_triusers')}}" productimage="product/07.png" productrating="4.5" productprice="$65.00" statuscolor="success" statusidentity="In Stock" deliverydate="Thu Jan 25" replacetime="10" />
