<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='Admin Dashboard'>
       ...
       <div class="card">
         <div class="card-header">
            <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
               <h4 class="mb-0">{{__('e-commerce.rev')}}</h4>
         ...
         <div class="col-md-12">
            <div class="overflow-hidden card">
               <div class="flex-wrap card-header d-flex align-items-center justify-content-between flex-wrap">
                  ...
                  <div class="d-flex align-items-center">
                     <div class="dropdown">
                        <a href="#" class="text-secondary dropdown-toggle" id="top-seller" data-bs-toggle="dropdown" aria-expanded="false">
                        {{__('e-commerce.profiles')}}
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="top-seller" style="">
                           <li><a class="dropdown-item" href="#">{{__('e-commerce.profiles')}}</a></li>
                           <li><a class="dropdown-item" href="#">{{__('e-commerce.country')}}</a></li>
                           <li><a class="dropdown-item" href="#">{{__('e-commerce.prod')}}</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="px-0 card-body">
                  <div class="table-responsive">
                     ...
                     <table class="table-striped table table-sm py-3" role="grid" data-table="eCommerce-admin">
                        <thead>
                           <tr>
         ...
         <div class="col-lg-6 col-md-6">
            <div class="card">
               <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <div class="dropdown">
                     <svg width="5" height="20" viewBox="0 0 5 20" fill="none" xmlns="http://www.w3.org/2000/svg" role="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        <circle cx="2.5" cy="3" r="2.5" fill="#E9ECEF"/>
                        <circle cx="2.5" cy="10" r="2.5" fill="#E9ECEF"/>
                        <circle cx="2.5" cy="17" r="2.5" fill="#E9ECEF"/>
                     </svg>
                     <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">{{__('e-commerce.wish')}}</a></li>
                        <li><a class="dropdown-item" href="#">{{__('e-commerce.advertise')}}</a></li>
                        <li><a class="dropdown-item" href="#">{{__('e-commerce.notification_preference')}}</a></li>
                     </ul>
                  </div>
               </div>
               <div class="card-body">
                  <div class="d-flex selling-card align-items-center">
                     <img src="{{asset('modules/e-commerce/images/product/04.png')}}" alt="user-profile" class="img-fluid rounded me-0 me-sm-5 bg-soft-secondary w-50">
                     <div class="selling-details">
                        <h5 class="mb-3 text-secondary">{{__('e-commerce.jacket')}}</h5>
         ...
         <div class="col-lg-6 col-md-6">
            <div class="card">
               <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <div class="dropdown">
                     <svg width="5" height="20" viewBox="0 0 5 20" fill="none" xmlns="http://www.w3.org/2000/svg" role="button" id="product-view" data-bs-toggle="dropdown" aria-expanded="false">
                        <circle cx="2.5" cy="3" r="2.5" fill="#E9ECEF"/>
                        <circle cx="2.5" cy="10" r="2.5" fill="#E9ECEF"/>
                        <circle cx="2.5" cy="17" r="2.5" fill="#E9ECEF"/>
                     </svg>
               ...
               <div class="card-body">
                  <div class="d-flex selling-card align-items-center">
                     <img src="{{asset('modules/e-commerce/images/product/09.png')}}" alt="user-profile" class="img-fluid rounded me-0 me-sm-5 bg-soft-secondary w-50">
                     <div class="selling-details">
                        <h5 class="mb-3 text-secondary">{{__('e-commerce.bag')}}</h5>
                        <h4 class="mb-3">$56.00</h4>
            ...
            <div class="card-body d-flex flex-column">
               <ul class="list-inline m-0 p-0">
                  <li class="d-flex mb-4 align-items-center">
                     <div>
                        <img src="{{asset('modules/e-commerce/images/product/04.png')}}" alt="story-img" class="img-fluid rounded object-contain avatar-90 iq-product-bg">
                     </div>
                     <div class="ms-4">
                        ...
                        <div class="d-flex align-items-center">
                              <svg xmlns="http://www.w3.org/2000/svg" class="me-2 h5" height="19" viewBox="0 0 24 24" fill="none">
                  ...
                  <li class="d-flex mb-4 align-items-center">
                     ...
                     <div class="ms-4">
                        ...
                        <div class="d-flex align-items-center">
                              <svg xmlns="http://www.w3.org/2000/svg" class="me-2" height="19" viewBox="0 0 24 24" fill="none">
                                 <path fill-rule="evenodd" clip-rule="evenodd" d="M13.1043 4.17701L14.9317 7.82776C15.1108 8.18616 15.4565 8.43467 15.8573 8.49218L19.9453 9.08062C20.9554 9.22644 21.3573 10.4505 20.6263 11.1519L17.6702 13.9924C17.3797 14.2718 17.2474 14.6733 17.3162 15.0676L18.0138 19.0778C18.1856 20.0698 17.1298 20.8267 16.227 20.3574L12.5732 18.4627C12.215 18.2768 11.786 18.2768 11.4268 18.4627L7.773 20.3574C6.87023 20.8267 5.81439 20.0698 5.98724 19.0778L6.68385 15.0676C6.75257 14.6733 6.62033 14.2718 6.32982 13.9924L3.37368 11.1519C2.64272 10.4505 3.04464 9.22644 4.05466 9.08062L8.14265 8.49218C8.54354 8.43467 8.89028 8.18616 9.06937 7.82776L10.8957 4.17701C11.3477 3.27433 12.6523 3.27433 13.1043 4.17701Z" fill="#FFD329"></path>
                              </svg>
                              <p class="mb-0">3.5</p>
                        </div>
                  ...
                  <li class="d-flex mb-4 align-items-center">
                     <div>
                        <img src="{{asset('modules/e-commerce/images/product/07.png')}}" alt="story-img" class="img-fluid rounded object-contain avatar-90 iq-product-bg">
                     </div>
                     <div class="ms-4">
                        <a href="{{route('e-commerce.product-detail')}}">
                           <h5 class="iq-product-detail">
                  ...
                  <li class="d-flex mb-4 align-items-center">
                     <div>
                        <img src="{{asset('modules/e-commerce/images/product/02.png')}}" alt="story-img" class="img-fluid rounded object-contain avatar-90 iq-product-bg">
                     </div>
                     <div class="ms-4">
                        <a href="{{route('e-commerce.product-detail')}}">
                           <h5 class="iq-product-detail">
                  ...
                  <li class="d-flex mb-4 align-items-center">
                     <div>
                        <img src="{{asset('modules/e-commerce/images/product/05.png')}}" alt="story-img" class="img-fluid rounded object-contain avatar-90 iq-product-bg">
                     </div>
                     <div class="ms-4">
                        <a href="{{route('e-commerce.product-detail')}}">
                           <h5 class="iq-product-detail">
                  ...
                  <li class="d-flex mb-4 align-items-center">
                     <div>
                        <img src="{{asset('modules/e-commerce/images/product/10.png')}}" alt="story-img" class="img-fluid rounded object-contain avatar-90 iq-product-bg">
                     </div>
                     <div class="ms-4">
                        <a href="{{route('e-commerce.product-detail')}}">
                           <h5 class="iq-product-detail">
               ...
               <a href="{{route('e-commerce.categories-list')}}" class="btn btn-primary align-self-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <svg class="ms-3" width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
