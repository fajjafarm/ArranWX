<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='Vendor Dashboard'>
   ...
   <div class="col-lg-8 col-md-12">
      ...
      <div class="card">
         <div class="card-header">
            <div class="d-flex align-items-center justify-content-between border-bottom pb-3 flex-wrap">
   ...
   <div class="col-lg-4 col-md-12">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="text-center">
                     <a href="#" class="btn btn-soft-primary border-primary border-1 border-dashed" data-bs-toggle="modal" data-bs-target="#add-card-modal">Add Your Card</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="card">
         <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <svg width="12" class="ms-1"  id="dropdownMenuLink1" role="button" data-bs-toggle="dropdown" aria-expanded="false" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M9 1.5L5 5.5L1 1.5" stroke="#3A57E8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
