<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='User List'>

<div class="row">
   <div class="col-lg-12">
       <div class="card">
           <div class="card-body">
                <h5 class="mb-0">{{__('e-commerce.user_list')}}</h5>
                <div class="simple-table table-responsive mt-4">
                    <table class="table-striped table table mb-0" id="datatable" data-toggle="data-table">
                        <thead>
                            <tr class="bg-white">
                                <th scope="col">{{__('e-commerce.profiles')}}</th>
                                <th scope="col">{{__('e-commerce.con')}}</th>
                                <th scope="col">{{__('e-commerce.email_id')}}</th>
                                <th scope="col">{{__('e-commerce.country')}}</th>
                                <th scope="col">{{__('e-commerce.purs')}}</th>
                                <th scope="col">{{__('e-commerce.status')}}</th>
                                <th scope="col">{{__('e-commerce.act')}}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/1.png')}}" alt="">
                                ...
                                <td>
                                    <span class="badge bg-soft-primary rounded-pill p-2 text-primary">Active</span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/2.png')}}" alt="">
                                        <div class="media-support-info">
                                ...
                                <td>
                                    <span class="badge bg-soft-warning rounded-pill p-2 text-warning">Pending</span>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-evenly">
                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/3.png')}}" alt="">
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/4.png')}}" alt="">
                                        <div class="media-support-info">
                                ...
                                <td>
                                    <span class="badge bg-soft-success rounded-pill p-2 text-success">Complete</span>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-evenly">
                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/5.png')}}" alt="">
                                        <div class="media-support-info">
                                ...
                                <td>
                                    <span class="badge bg-soft-danger rounded-pill p-2 text-danger">Inactive</span>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-evenly">
                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/6.png')}}" alt="">
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/7.png')}}" alt="">
                                        <div class="media-support-info">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/8.png')}}" alt="">
                                        <div class="media-support-info">
                                        <h5 class="iq-sub-label">Elon Musk</h5>
                                        <p class="mb-0">@musk</p>
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded img-fluid avatar-65 me-3" src="{{asset('images/table/9.png')}}" alt="">
                                        <div class="media-support-info">
                                        <h5 class="iq-sub-label">Elon Musk</h5>
                                        <p class="mb-0">@musk</p>
                                        </div>
                                ...
                                <td class="text-dark">
                                    <svg width="18" class="me-2" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M18.9995 4.83789L16.8359 1.09033" stroke="black" stroke-width="0.5" stroke-dasharray="8 1"/>
                                        <path d="M18.0366 5.39551L15.873 1.64795" stroke="black" stroke-width="0.5"/>
                                        <path d="M17.0728 5.95117L14.9091 2.20361" stroke="black" stroke-width="0.5" stroke-dasharray="8 1"/>
                                        <path d="M2.16406 11.5049L4.32772 15.2524" stroke="black" stroke-width="0.5"/>
                                        <path d="M3.12744 10.9492L5.2911 14.6968" stroke="black" stroke-width="0.5" stroke-dasharray="8 1"/>
                                        <path d="M4.09082 10.3926L6.25447 14.1401" stroke="black" stroke-width="0.5"/>
                                        <path d="M18.9995 11.5049L16.8359 15.2524" stroke="black" stroke-width="0.5" stroke-dasharray="8 1"/>
                                        <path d="M18.0366 10.9492L15.873 14.6968" stroke="black" stroke-width="0.5" stroke-dasharray="8 1"/>
                                        <path d="M17.0732 10.3926L14.9096 14.1401" stroke="black" stroke-width="0.5" stroke-dasharray="8 1"/>
                                    </svg>
                                    S.KO
                                </td>
                                <td class="text-dark">548</td>
