      ...
      <div class="card">
         ...
         <div class="card-body">
            <div class="nav nav-tabs nav-iconly gap-5 mb-5" id="myTab" role="tablist">
                  <button class="nav-link active" id="order-tab" data-bs-toggle="tab" data-bs-target="#order" type="button" role="tab" aria-controls="order" aria-selected="false">
                  ...
                  <button class="nav-link" id="adress-tab" data-bs-toggle="tab" data-bs-target="#adress" type="button" role="tab" aria-controls="adress" aria-selected="false">
                     <svg class="icon-40" xmlns="http://www.w3.org/2000/svg" width="40" viewBox="0 0 40 40" fill="currentColor">
                  ...
                  <button class="nav-link" id="card-tab" data-bs-toggle="tab" data-bs-target="#card" type="button" role="tab" aria-controls="card" aria-selected="true">
                     <svg class="icon-40" xmlns="http://www.w3.org/2000/svg" width="40" viewBox="0 0 40 40" fill="currentColor">
               ...
               <div class="tab-pane fade active show" id="order" role="tabpanel" aria-labelledby="order-tab">
                  <div class="d-flex align-items-center justify-content-between flex-wrap">
                     ...
                     <div class="dropdown text-end pb-3">
                        <button class="dropdown btn btn-soft-primary" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                           {{__('e-commerce.last')}} 90 {{__('e-commerce.days')}}
                           <svg width="12" class="ms-2" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="dropdown-menu dropdown-menu-soft-primary" aria-labelledby="dropdownMenuButton2">
                           <li><a class="dropdown-item active" href="#">{{__('e-commerce.last')}}Last 30 {{__('e-commerce.days')}}Days</a></li>
                           <li><a class="dropdown-item" href="#">{{__('e-commerce.last')}}Last 90 {{__('e-commerce.days')}}Days</a></li>
                           <li><a class="dropdown-item" href="#">{{__('e-commerce.last')}}Last 180 {{__('e-commerce.days')}}Days</a></li>
                           <li><hr class="dropdown-divider"></li>
                           <li><a class="dropdown-item" href="#">{{__('e-commerce.last')}}Last 1 {{__('e-commerce.year')}}</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="card shadow-none border iq-product-order-placed">
                     <div class="card-header user-details-bg-color p-4">
                        <div class="iq-order-content">
                           <div class="iq-order-user-details d-flex justify-content-between align-items-center">
                              <div class="me-5">
                     ...
                     <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                           <div class="d-flex align-items-center">
                              <img src="{{asset('modules/e-commerce/images/app/01.png')}}" alt="user-profile" class="img-fluid rounded object-contain avatar-100 iq-product-bg p-3">
                              <div class="ms-3">
                           ...
                           <div class="mt-3 mt-xl-0 mt-3 mt-md-0">
                              <div class="dropdown text-end">
                                 <button class="dropdown btn btn-primary mb-3" id="buy-drop" data-bs-toggle="dropdown" aria-expanded="false">
                                 {{__('e-commerce.buy_it_again')}}
                                    <svg width="12" class="ms-2" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path fill-rule="evenodd" clip-rule="evenodd" d="M6 5.08579L10.2929 0.792893C10.6834 0.402369 11.3166 0.402369 11.7071 0.792893C12.0976 1.18342 12.0976 1.81658 11.7071 2.20711L6.70711 7.20711C6.31658 7.59763 5.68342 7.59763 5.29289 7.20711L0.292893 2.20711C-0.0976311 1.81658 -0.0976311 1.18342 0.292893 0.792893C0.683418 0.402369 1.31658 0.402369 1.70711 0.792893L6 5.08579Z" fill="currentColor"/>
                                    </svg>
                                 </button>
                                 <ul class="dropdown-menu dropdown-menu-soft-primary" aria-labelledby="buy-drop">
                                    <li><a class="dropdown-item active" href="#">{{__('e-commerce.buy_it_again')}}</a></li>
                                    <li><a class="dropdown-item" href="#">{{__('e-commerce.replace')}}</a></li>
                                    <li><a class="dropdown-item" href="#">{{__('e-commerce.view')}}</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" href="#">{{__('e-commerce.cancel_order')}}</a></li>
                                 </ul>
                              </div>
                              <div class="text-center">
                                 <a href="{{route('e-commerce.order-process')}}">{{__('e-commerce.invoice')}}</a>
                                 <span>|</span>
                                 <a href="{{route('e-commerce.order-process')}}">{{__('e-commerce.write_a_review')}}</a>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="card shadow-none border iq-product-order-placed">
                     ...
                     <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                           <div class="d-flex align-items-center">
                              <img src="{{asset('modules/e-commerce/images/app/02.png')}}" alt="user-profile" class="img-fluid rounded object-contain avatar-100 iq-product-bg p-3">
                              <div class="ms-3">
                                 <a href="{{route('e-commerce.product-detail')}}">
                        ...
                        <div class="border border-3 border-dashed p-2 mb-4">
                           <div class="text-center">
                              <a href="#" class="d-flex align-items-center justify-content-center">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="30" class="text-secondary" viewBox="0 0 30 30" fill="none">
                                    <path d="M12.6035 27H17.3787V17.3787H27V12.6036H17.3787V3H12.6035V12.6036H3V17.3787H12.6035V27Z" fill="currentColor"></path>
                                 </svg>
                                 <h6 class="ms-2 mb-0">{{__('e-commerce.add_address')}}</h6>
                              </a>
                           </div>
                        </div>
                     </div>
                    <x-modules.e-commerce.widgets.user-account-cards cardclass="" classcarddefault="bg-soft-secondary" addressmode="Default" username="Elon Musk" addresstype="Home" usercontact="(303) 555-0105" add_fivess=""  useraddress="{{__('e-commerce.add_five')}}" />
                    <x-modules.e-commerce.widgets.user-account-cards cardclass="border iq-user-address" classcarddefault="" addressmode="" username="Christopher Nolan" addresstype="Office" usercontact="(+994) 569-05210" add_fivess="" useraddress="{{__('e-commerce.add_five')}}" />
                    <x-modules.e-commerce.widgets.user-account-cards cardclass="border iq-user-address" classcarddefault="" addressmode="" username="Christopher Nolan" addresstype="Home" usercontact="(+994) 569-05210" add_fivess="" useraddress="{{__('e-commerce.add_five')}}" />
                    <x-modules.e-commerce.widgets.user-account-cards cardclass="border iq-user-address mb-0" classcarddefault="" addressmode="" username="Christopher Nolan" addresstype="Office" usercontact="(+994) 569-05210" add_fivess="" useraddress="{{__('e-commerce.add_five')}}" />
                  </div>
               </div>
               <div class="tab-pane fade" id="card" role="tabpanel" aria-labelledby="card-tab">
                  ...
                  <div class="border rounded">
                     <div class="card shadow-none mb-0">
                        <div class="card-header border-bottom d-flex flex-wrap justify-content-between py-4 px-0 mx-4">
                           <h5 class="mb-0">{{__('e-commerce.your_default_payment_preference')}} </h5>
                        ...
                        <div class="card-body">
                           <div class="row">
                              ...
                              <div class="col-lg-4">
                                 ...
                                 <p class="mt-2 mb-0">{{__('e-commerce.bank_of_america_debit_card')}}</p>
                              </div>
                           </div>
                        </div>
                     </div>
                              ...
                              <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="accordion-header" id="headingOne">
                                       <div class="accordion-button" role="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                          <div class="d-flex flex-grow-1 align-items-center ">
                                             <img src="{{asset('modules/e-commerce/images/user-cards/01.png')}}" alt="image" class="img-fluid">
                                             <h6 class="ms-3 card-details mb-0">{{__('e-commerce.BOA_debit_card')}} 0654</h6>
                                          </div>
                                          <div>
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                       <div class="accordion-body">
                                          <div class="d-flex flex-column">
                                             ...
                                             <a href="#" >
                                                <small class="text-primary">{{__('e-commerce.edit')}} | {{__('e-commerce.remove')}}</small>
                                             </a>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="accordion-item shadow-none border-0 mb-4">
                                    <div class="accordion-header" id="headingTwo">
                                       <div class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                          <div class="d-flex flex-grow-1 align-items-center">
                                             <img src="{{asset('modules/e-commerce/images/user-cards/01.png')}}" alt="image" class="img-fluid">
                                             <h6 class="ms-3 card-details mb-0">{{__('e-commerce.cb_credit_card')}} 6549</h6>
                                          </div>
                                          <div>
                                 ...
                                 <div class="accordion-item shadow-none border-0 mb-4">
                                    <div class="accordion-header" id="headingThree">
                                       <div class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                          <div class="d-flex flex-grow-1 align-items-center">
                                             <img src="{{asset('modules/e-commerce/images/user-cards/02.png')}}" alt="image" class="img-fluid">
                                             <h6 class="ms-3 card-details mb-0">{{__('e-commerce.bb_debit_card')}} 7852</h6>
                                          </div>
                                          <div>
                                 ...
                                 <div class="accordion-item shadow-none border-0">
                                    <div class="accordion-header" id="headingFour">
                                       <div class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                          <div class="d-flex flex-grow-1 align-items-center">
                                             <img src="{{asset('modules/e-commerce/images/user-cards/01.png')}}" alt="image" class="img-fluid">
                                             <h6 class="ms-3 card-details mb-0">{{__('e-commerce.BOA_debit_card')}} 6555</h6>
                                          </div>
                                          <div>
                                             <h6 class="text-danger mx-2 mb-0">{{__('e-commerce.expired')}} 08/2021</h6>
                                          </div>
                                       </div>
                                    </div>
                     ...
                     <div class="card shadow-none mb-0">
                        <div class="card-body">
                           <div class="d-flex justify-content-between align-items-center">
                              <div>
                                 <h5 class="mb-3">{{__('e-commerce.add_a_new_payment_method')}}</h5>
                                 <h5 class="mb-1">{{__('e-commerce.credit_or_debit_cards')}}</h5>
                                 <p>{{__('e-commerce.we_accept_all_major_credit')}}</p>
                              </div>
                              <div>
                                 <img src="{{asset('modules/e-commerce/images/user-cards/01.png')}}" alt="user-profile" class="img-fluid mt-3 me-3">
                                 <img src="{{asset('modules/e-commerce/images/user-cards/03.png')}}" alt="user-profile" class="img-fluid mt-3 me-3">
                                 <img src="{{asset('modules/e-commerce/images/user-cards/05.png')}}" alt="user-profile" class="img-fluid mt-3 me-3">
                                 <img src="{{asset('modules/e-commerce/images/user-cards/04.png')}}" alt="user-profile" class="img-fluid mt-3 me-3">
                                 <img src="{{asset('modules/e-commerce/images/user-cards/02.png')}}" alt="user-profile" class="img-fluid mt-3 me-3">
                              </div>
                           </div>
                           <button class="btn btn-primary mt-3">{{__('e-commerce.add_a_credit')}}</button>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="card-header border-bottom py-4 px-0 mx-4">
                        <div class="d-flex justify-content-between align-items-center">
                           ...
                           <button class="btn btn-primary">
                              <div class="d-block d-md-none" data-bs-toggle="tooltip" data-bs-placement="top" editle="                     r     e">
                        ...
                        <h6 class="mb-2">{{__('e-commerce.avatar')}}</h6>
                           <div class="d-flex align-items-center justify-content-center">
                              <div class="position-relative">
                                 <img src="{{asset('modules/e-commerce/images/user/06.png')}}" alt="user-profile" class="img-fluid edit-img border border-white border-4 rounded-circle">
                                 <div class="iq-icon-edit position-absolute btn btn-primary btn-sm rounded-circle p-1">
                                    <svg class="upload-button" width="20"  viewBox="0 0 24 24">
                                       <path fill="#ffffff" d="M14.06,9L15,9.94L5.92,19H5V18.08L14.06,9M17.66,3C17.41,3 17.15,3.1 16.96,3.29L15.13,5.12L18.88,8.87L20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18.17,3.09 17.92,3 17.66,3M14.06,6.19L3,17.25V21H6.75L17.81,9.94L14.06,6.19Z" />
                                    </svg>
                                 </div>
                                 <div class="iq-icon-cancel position-absolute btn btn-primary btn-sm rounded-circle p-1">
                                    <svg width="20" viewBox="0 0 24 24" fill="none">
                                       <path d="M17 7L7 17M7 7L17 17L7 7Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="form-label" for="firstname">{{__('e-commerce.first_name')}}</label>
                                    <input type="text" class="form-control" id="firstname" placeholder=" ">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="form-label" for="lastname">{{__('e-commerce.last_name')}}</label>
                                    <input type="text" class="form-control" id="lastname" placeholder=" ">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="form-label" for="contact">{{__('e-commerce.con_no')}}</label>
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="form-label" for="house">{{__('e-commerce.hname')}}</label>
                                    <input type="text" class="form-control" id="house" placeholder=" ">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="form-label" for="landmark">{{__('e-commerce.lmark')}}</label>
                                    <input type="text" class="form-control" id="landmark" placeholder=" ">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="form-label" for="address">{{__('e-commerce.street')}}</label>
                                    <input type="text" class="form-control" id="address" placeholder=" ">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="form-label" for="city">{{__('e-commerce.town')}}</label>
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label class="form-label" for="code">{{__('e-commerce.zip')}}</label>
                                    <input type="text" class="form-control" id="code" placeholder=" ">
                                 </div>
                              </div>
                           </div>
                           <button type="submit" class="btn btn-primary">{{__('e-commerce.save_changes')}}</button>
                        </form>
                     </div>
                  </div>
                  <div class="card border border-dashed border-3 shadow-none mb-0 rounded border-primary">
                     <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                     ...
                     <div class="card-body">
                        <div class="d-flex align-items-center">
                           <div>
                              <svg xmlns="http://www.w3.org/2000/svg" width="32" viewBox="0 0 24 24" fill="none" class="text-success">
                                 ...
                                 <path d="M9.38591 11.8746L11.2779 13.7696L15.1759 9.86963" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              </svg>
                           </div>
                           <p class="ms-3 mb-0">{{__('e-commerce.two_factor')}}</p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <ul class="list-inline m-0 p-0">
               <li class="d-flex align-items-center mb-4 flex-wrap justify-content-center">
                  <div class="mb-0 mb-xl-0 mb-md-0 mb-lg-4">
                        <img src="{{asset('modules/e-commerce/images/product/04.png')}}" alt="user-profile" class="img-fluid rounded object-contain avatar-80 iq-product-bg">
                  </div>
                  ...
                  <a class="btn btn-primary btn-icon btn-sm rounded-circle" href="{{route('e-commerce.order-process')}}" role="button">
               ...
               <li class="d-flex align-items-center mb-4 flex-wrap justify-content-center">
                  <div class="mb-0 mb-xl-0 mb-md-0 mb-lg-4">
                        <img src="{{asset('modules/e-commerce/images/product/06.png')}}" alt="user-profile" class="img-fluid rounded object-contain avatar-80 iq-product-bg">
                  </div>
                  <div class="flex-grow-1 ms-3">
                     <a href="{{route('e-commerce.product-detail')}}" class="h6 iq-product-detail">
               ...
               <li class="d-flex align-items-center mb-4 flex-wrap justify-content-center">
                  <div class="mb-0 mb-xl-0 mb-md-0 mb-lg-4">
                        <img src="{{asset('modules/e-commerce/images/product/07.png')}}" alt="user-profile" class="img-fluid rounded object-contain avatar-80 iq-product-bg">
                  </div>
                  <div class="flex-grow-1 ms-3">
                     <a href="{{route('e-commerce.product-detail')}}" class="h6 iq-product-detail">
               ...
               <li class="d-flex align-items-center flex-wrap justify-content-center">
                  <div class="mb-0 mb-xl-0 mb-md-0 mb-lg-4">
                        <img src="{{asset('modules/e-commerce/images/product/02.png')}}" alt="user-profile"  class="img-fluid rounded object-contain avatar-80 iq-product-bg">
                  </div>
                  <div class="flex-grow-1 ms-3">
                     <a href="{{route('e-commerce.product-detail')}}" class="h6 iq-product-detail">
                     {{__('e-commerce.shoe')}}
