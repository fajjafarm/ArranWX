<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='Order Proess' isSweetalert="true">
    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="d-flex justify-content-between flex-wrap">
                                    <a id="backbutton" href="#checkout" class="btn btn-soft-primary d-block back justify-content-between">{{__('e-commerce.back')}}</a>
