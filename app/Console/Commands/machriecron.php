...
class machriecron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'machriecron';
     ...
     * @var string
     */
    protected $description = 'machrie wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.5561&lon=-5.3388&altitude=2";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('machrie.json', $contents)) {
