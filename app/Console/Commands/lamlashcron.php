...
class lamlashcron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lamlashcron';
     ...
     * @var string
     */
    protected $description = 'lamlash wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.5330&lon=-5.1327&altitude=0";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('lamlash.json', $contents)) {
