...
class lochranzacron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lochranzacron';
     ...
     * @var string
     */
    protected $description = 'lochranza wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.7030&lon=-5.2907&altitude=0";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('lochranza.json', $contents)) {
