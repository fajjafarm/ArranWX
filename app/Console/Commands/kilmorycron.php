...
class kilmorycron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'kilmorycron';
     ...
     * @var string
     */
    protected $description = 'kilmory wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.4441&lon=-5.2319&altitude=5";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('kilmory.json', $contents)) {
