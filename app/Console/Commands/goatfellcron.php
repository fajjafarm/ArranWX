...
class goatfellcron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'goatfellcron';
     ...
     * @var string
     */
    protected $description = 'goatfell wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.6256&lon=-5.1932&altitude=874";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('goatfell.json', $contents)) {
