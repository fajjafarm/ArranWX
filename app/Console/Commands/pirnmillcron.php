...
class pirnmillcron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'pirnmillcron';
     ...
     * @var string
     */
    protected $description = 'pirnmill wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.6500&lon=-5.3732&altitude=2";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('pirnmill.json', $contents)) {
