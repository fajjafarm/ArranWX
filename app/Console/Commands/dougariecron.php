...
class dougariecron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dougariecron';
     ...
     * @var string
     */
    protected $description = 'dougarie wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.5822&lon=-5.3589&altitude=3";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('dougarie.json', $contents)) {
