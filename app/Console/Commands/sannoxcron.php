...
class sannoxcron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sannoxcron';
     ...
     * @var string
     */
    protected $description = 'sannox wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.6624&lon=-5.1601&altitude=8";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('sannox.json', $contents)) {
