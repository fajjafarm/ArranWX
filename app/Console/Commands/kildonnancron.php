...
class kildonnancron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'kildonnancron';
     ...
     * @var string
     */
    protected $description = 'kildonnan wx';
...
$context = stream_context_create($options);
                ...
                $path = "https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=55.4432&lon=-5.1090&altitude=0";
                $contents = file_get_contents($path, false, $context);
                
                if (! Storage::put('kildonnan.json', $contents)) {
